	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("M8CLoco", "M8CLoco", EntityElectricM8CLoco.class, ItemIDs.minecartM8CLoco.item, "electric", 250, 70, 0, 20, 0, 100, 0.7, 0.8, 1000, new String[]{"Yellow","Blue","LightBlue","Red", "Grey", "Black", "Orange","LightGrey","Cyan"}, 18, -2.3, "Pack: Trams In Motion"),
				TrainRecord.makeEntry("M8CTail", "M8CTail", EntityPassengerM8CTail.class, ItemIDs.minecartM8CTail.item, "passenger", 0, 0, 1, 0, 0, 0, 0, 0, 0, new String[]{"Yellow","Blue","LightBlue","Red", "Grey", "Black", "Orange","LightGrey","Cyan"}, 18, -2.3, "Pack: Trams In Motion"),
				...
				TrainRecord.makeEntry("DuewagGT6ERLoco", "DuewagGT6ERLoco", EntityElectricDuewagGT6ERLoco.class, ItemIDs.minecartDuewagGT6ERLoco.item, "electric", 250, 70, 0, 20, 0, 100, 0.7, 0.8, 1000, new String[]{"Green", "Grey", "Orange", "Red", "Yellow", "Blue"}, 18, -2.35, "Pack: Trams In Motion"),
				TrainRecord.makeEntry("DuewagGT6ERTail", "DuewagGT6ERTail", EntityPassengerDuewagGT6ERTail.class, ItemIDs.minecartDuewagGT6ERTail.item, "passenger", 0, 0, 1, 0, 0, 0, 0, 0, 0, new String[]{ "Green", "Grey", "Orange", "Red", "Yellow", "Blue"}, 18, -2.65, "Pack: Trams In Motion"),
