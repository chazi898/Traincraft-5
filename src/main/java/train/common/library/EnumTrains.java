	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("BR_Black_5", "BR_Black_5", EntityLocoSteamBR_Black_5.class, ItemIDs.minecartBR_Black_5.item, "steam", 1450, 149, 3, 10, 10, 100, 0.7, 0.7, 8000, new String[]{"Black", "Grey", "LightGrey", "Red", "White", "Magenta", "Yellow", "Purple"}, 18, -3.5f, "Pack: B.I.P."),
