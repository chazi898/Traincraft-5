	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("BR_MK3_Buffet", "BR_MK3_Buffet", EntityPassengerBR_MK3_Buffet.class, ItemIDs.minecartBR_MK3_Buffet.item, "passenger", 0, 0, 3.2, 0, 0, 0, 0, 0, 0, new String[]{"Blue", "Cyan", "Black", "Brown", "Red", "White", "Pink", "LightGrey", "Green", "Magenta", "Yellow", "LightBlue", "Grey", "Purple", "Orange", "Lime", "Skin17", "Skin18", "Skin19"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("BR_MK3_Coach", "BR_MK3_Coach", EntityPassengerBR_MK3_Coach.class, ItemIDs.minecartBR_MK3_Coach.item, "passenger", 0, 0, 3.2, 0, 0, 0, 0, 0, 0, new String[]{"Blue", "Cyan", "Black", "Brown", "Red", "White", "LightGrey", "Green", "Magenta", "Yellow", "Grey", "Lime", "LightBlue", "Purple", "Skin16", "Skin17", "Skin18", "Skin19", "Skin20", "Skin21", "Skin22", "Skin23", "Skin24"}, 0, 0, "Pack: B.I.P."),
				...
				/** TCCE-MLP-3 */
				TrainRecord.makeEntry("Class17", "Class17", EntityLocoDieselClass17.class, ItemIDs.minecartClass17.item, "diesel",900, 97, 0, 10, 0, 100, 0.6, 0.65, 23000, new String[]{"Black", "Blue", "Green", "Grey", "Yellow"}, 18, -3, "Pack: B.I.P."),
