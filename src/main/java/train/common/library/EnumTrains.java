	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("BR_MK3_DVT", "BR_MK3_DVT", EntityElectricBR_MK3_DVT.class, ItemIDs.minecartBR_MK3_DVT.item, "electric", 1100, 201, 3, 60, 0, 0, 0.8, 0.645, 0, new String[]{"Blue", "Cyan", "Grey", "LightGrey", "Red", "White", "Yellow", "LightBlue", "Lime"}, 18, -4, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("BR_Black_5", "BR_Black_5", EntityLocoSteamBR_Black_5.class, ItemIDs.minecartBR_Black_5.item, "steam", 1450, 149, 3, 10, 10, 100, 0.7, 0.7, 8000, new String[]{"Black", "Grey", "LightGrey", "Red", "White", "Magenta", "Yellow", "Purple", "Orange"}, 18, -3.5f, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class43", "Class43", EntityLocoDieselClass43.class, ItemIDs.minecartClass43.item, "diesel", 2250, 238, 0, 25, 0, 180, 0.7, 0.7, 13000, new String[]{"White", "Blue", "Brown", "Green", "Red", "Cyan", "LightBlue", "Orange", "Yellow", "Purple", "Pink", "Black", "Grey", "LightGrey", "Magenta", "Lime", "Skin17", "Skin18", "Skin19", "Skin20", "Skin21", "Skin22"}, 0, -3.15, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class90", "Class90", EntityElectricClass90.class, ItemIDs.minecartClass90.item, "electric", 5000, 178, 0, 60, 0, 100, 0.75, 0.7, 1000, new String[]{"Black", "Green", "LightGrey", "Grey", "Pink", "Red", "White", "Magenta", "Brown", "Orange"}, 18, -2.77, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class91", "Class91", EntityElectricClass91.class, ItemIDs.minecartClass91.item, "electric", 6300, 260, 0, 60, 0, 100, 0.7, 0.7, 1000, new String[]{"Blue", "Red", "White", "Pink"}, 18, -4.25, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class321", "Class321", EntityElectricClass321.class, ItemIDs.minecartClass321.item, "electric", 1438, 178, 0, 60, 0, 100, 0.7, 0.7, 1000, new String[]{"Purple", "Grey", "White", "Red", "Green", "Blue", "LightGrey", "Lime"}, 18, -4, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("GWR_42xx", "GWR42xx", EntityLocoSteamGWR42xx.class, ItemIDs.minecartGWR42xx.item, "steam", 1300, 105, 0, 10, 10, 100, 0.7, 0.7, 8200, new String[]{"Black", "Blue", "Brown", "Cyan", "Green", "Grey", "LightBlue", "LightGrey", "Lime", "Orange", "Pink", "Red", "White", "Yellow", "Skin17", "Skin18"}, 18, -2.54f, "Pack: B.I.P."),
				TrainRecord.makeEntry("GWR_72xx", "GWR72xx", EntityLocoSteamGWR72xx.class, ItemIDs.minecartGWR72xx.item, "steam", 1375, 105, 0, 10, 10, 100, 0.7, 0.7, 9000, new String[]{"Black", "Blue", "Green", "Grey", "Lime", "Orange", "Pink"}, 18, -3.5f, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("BR_Britannia_Class", "BRBritanniaClass", EntityLocoSteamBR_Britannia_Class.class, ItemIDs.minecartBRBritanniaClass.item, "steam", 1950, 161, 0, 10, 10, 100, 0.7, 0.7, 8000, new String[]{"Green", "Black", "Blue", "Grey", "Magenta", "Red", "White", "Yellow", "Cyan", "Orange"}, 18, -4.1f, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("Class387Front", "Class387Front", EntityElectricClass387Front.class, ItemIDs.minecartClass387Front.item, "electric", 2250, 178, 0, 60, 0, 100, 0.7, 0.7, 1000, new String[]{"Cyan", "Pink", "Green", "Red", "Purple", "White", "Lime", "Black", "Blue", "LightBlue", "LightGrey", "Yellow", "Grey", "Orange"}, 18, -4, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("MRcompound", "MRCompound", EntitylocoSteamMRCompound.class, ItemIDs.minecartMRcompound.item, "steam", 2265, 137, 0, 10, 10, 120, 0.75, 0.7, 7500, new String[]{"Black", "Blue", "Green", "Grey", "Lightblue", "Lightgrey", "Lime", "Magenta", "Orange", "Pink", "Purple", "Red", "White", "Yellow"}, 0, -3, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("Bagnall", "Bagnall", EntityLocoDieselBagnall.class, ItemIDs.minecartBagnall.item, "diesel", 90, 100, 0, 5, 0, 100, 0.9, 0.9, 7500, new String[]{"Blue", "Red", "Yellow", "Cyan"}, 18, -2, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("Class442DTS", "Class442DTS", EntityElectricClass442DTS.class, ItemIDs.minecartClass442DTS.item, "electric", 1610, 175, 0, 60, 0, 100, 0.7, 0.7, 1000, new String[]{"Black", "White", "Lime", "Green", "Orange", "Yellow","Red", "Purple", "Blue", "Lightblue", "Pink"}, 18, -4.34, "Pack: B.I.P."),
				...
				/** TCCE-MLP */
				TrainRecord.makeEntry("Class68", "Class68", EntityLocoDieselClass68.class, ItemIDs.minecartClass68.item, "diesel", 3800, 161, 0, 10, 0, 100, 0.7, 0.8, 8000, new String[]{"Blue", "Purple", "Cyan", "LightBlue", "Grey"}, 18, -4.25, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class88", "Class88", EntityElectricClass88.class, ItemIDs.minecartClass88.item, "electric", 5400, 161, 0, 60, 0, 100, 0.75, 0.7, 1000, new String[]{"Blue", "Cyan", "Magenta", "Purple"}, 18, -4.25, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("GWRMogul", "GWRMogul", EntityLocoSteamGWRMogul.class, ItemIDs.minecartGWRMogul.item, "steam", 950, 121, 3, 10, 10, 100, 0.7, 0.7, 8000, new String[]{"Green", "Black", "Brown", "Grey", "LightBlue", "Lime", "Magenta", "Orange", "Red", "Yellow", "Blue"}, 18, -3.05f, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("Class71", "Class71", EntityLocoElectricClass71.class, ItemIDs.minecartClass71.item, "electric", 2552, 146, 0, 10, 0, 100, 0.6, 0.69, 1000, new String[]{"Black", "Blue", "Brown", "Cyan", "Green", "Grey", "LightBlue", "LightGrey", "Lime", "Magenta", "Orange", "Pink", "Purple", "Red", "White", "Yellow", "Skin17", "Skin18", "Skin19", "Skin20"}, 18, -3, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class74", "Class74", EntityLocoDieselClass74.class, ItemIDs.minecartClass74.item, "diesel", 2552, 141, 0, 10, 0, 100, 0.55, 0.69, 10000, null, 18, -3, "Pack: B.I.P."),
