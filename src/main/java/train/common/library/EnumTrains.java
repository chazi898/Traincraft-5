	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("Class389Front", "Class389Front", EntityElectricClass389Front.class, ItemIDs.minecartClass389Front.item, "electric", 2250, 188, 0, 60, 0, 100, 0.7, 0.7, 1000, new String[]{"Orange", "White", "Purple"}, 18, -4.35, "Pack: B.I.P."),
