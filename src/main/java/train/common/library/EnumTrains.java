	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("BR_MK4_DVT", "BR_MK4_DVT", EntityElectricBR_MK4_DVT.class, ItemIDs.minecartBR_MK4_DVT.item, "electric", 1100, 260, 3, 25, 0, 100, 0.8, 0.685, 1000, new String[]{"Blue", "Red", "White", "Black", "Pink"}, 18, -4.65, "Pack: B.I.P."),
