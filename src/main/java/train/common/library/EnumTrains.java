	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("tender_BR1", "Tender_BR1", EntityTenderBR1.class, ItemIDs.minecartBR1Tender.item, "tender", 0, 0, 0.6, 0, 0, 0, 0, 0, 16000, new String[]{"Green", "Black", "Blue", "Grey", "LightGrey", "Orange", "Yellow", "Cyan"}, 18, 0, "Water capacity: 16000mb B.I.P."),
