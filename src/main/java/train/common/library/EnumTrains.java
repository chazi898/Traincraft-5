	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("LessCoWagon", "LessCoWagon", EntityFreightLessCoWagon.class, ItemIDs.minecartLessCoWagon.item, "freight", 2.3, new String[]{"Blue", "Cyan", "Grey", "LightBlue", "Orange", "Red", "Yellow", "Brown", "LightGrey"}, 18, 54, "Cargo: any  B.I.P"),
				...
				TrainRecord.makeEntry("Class170", "Class170", EntityLocoDieselClass170.class, ItemIDs.minecartClass170.item, "diesel", 422, 161, 0, 10, 0, 100, 0.82, 0.72, 15000, new String[]{"White", "Brown", "Blue", "Green", "Grey", "LightBlue", "Lime", "Purple", "Red", "Orange", "Cyan"}, 18, -4.35, "Pack: B.I.P. Use 389 Middle Car"),
