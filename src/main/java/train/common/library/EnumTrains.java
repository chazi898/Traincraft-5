	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("Class90", "Class90", EntityElectricClass90.class, ItemIDs.minecartClass90.item, "electric", 5000, 178, 0, 60, 0, 100, 0.75, 0.74, 1000, new String[]{"Black", "Green", "LightGrey", "Grey", "Pink", "Red", "White", "Magenta", "Brown", "Yellow", "Orange"}, 18, -2.73, "Pack: B.I.P."),
