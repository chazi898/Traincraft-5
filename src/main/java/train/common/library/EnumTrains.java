	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("B80C_A", "B80C_A", EntityElectricB80C_A.class, ItemIDs.minecartB80C_A.item, "electric", 300, 80, 0, 60, 0, 100, 0.7, 0.8, 1000, new String[]{ "Red","Pink","White","Magenta","Yellow"}, 18, -2.4, "Pack: Metro In Motion"),
				TrainRecord.makeEntry("B80C_B", "B80C_B", EntityPassengerB80C_B.class, ItemIDs.minecartB80C_B.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{ "Red","Pink","White","Magenta","Yellow"}, 0, -2.4, "Pack: Metro In Motion"),
