	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("BR_MK3_Sleeper", "BR_MK3_Sleeper", EntityPassengerBR_MK3_Sleeper.class, ItemIDs.minecartBR_MK3_Sleeper.item, "passenger", 0, 0, 3.2, 0, 0, 0, 0, 0, 0, new String[]{"Blue", "Brown", "Cyan", "Green", "Pink", "Red", "White", "LightBlue", "Grey"}, 0, 0, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("Class357", "Class357", EntityElectricClass357.class, ItemIDs.minecartClass357.item, "electric", 2011, 161, 0, 60, 0, 100, 0.7, 0.75, 1000, new String[]{"White", "Purple", "Magenta"}, 18, -4, "Pack: B.I.P. Use 387 Middle Car"),
