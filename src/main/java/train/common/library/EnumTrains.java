	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("tender_BR_Black_5", "Tender_BR_Black_5", EntityTenderBR_Black_5.class, ItemIDs.minecartBR_Black_5_Tender.item, "tender", 0, 0, 2, 0, 0, 0, 0, 0, 16000, new String[]{"Blue", "Cyan", "Green", "Grey", "LightGrey", "Red", "White", "Magenta", "Yellow", "Purple", "Orange"}, 18, 0, "Water capacity: 16000mb B.I.P."),
				...
				TrainRecord.makeEntry("tender_LMS_10Ton", "Tender_LMS_10Ton", EntityTenderLMS_10Ton.class, ItemIDs.minecartLMS_10Ton_Tender.item, "tender", 0, 0, 2, 0, 0, 0, 0, 0, 16000, new String[]{"Red", "Black", "Grey", "LightBlue", "Purple", "LightGrey", "Blue", "Green", "Orange", "Magenta", "Yellow", "Cyan", "White", "Brown"}, 18, 0, "Water capacity: 16000mb B.I.P."),
				TrainRecord.makeEntry("tender042Jenny", "Tender042Jenny", EntityTender042Jenny.class, ItemIDs.minecart042JennyTender.item, "tender", 0, 0, 1.2, 0, 0, 0, 0, 0, 8000, new String[]{"Blue", "Green", "Red", "Yellow", "Black"}, 18, 0, "Water capacity: 8000mb B.I.P."),
				TrainRecord.makeEntry("tender_RW_Type_2", "Tender_RW_Type_2", EntityTenderRWType2.class, ItemIDs.minecartRWType2Tender.item, "tender", 0, 0, 0.6, 0, 0, 0, 0, 0, 10000, new String[]{"Black", "Blue", "Brown", "Green", "Grey", "LightGrey", "Lime", "Orange", "Purple", "Pink", "Red", "White"}, 18, 0, "Water capacity: 10000mb B.I.P."),
				...
				TrainRecord.makeEntry("locoElectricSpeedZeroED", "Loco Electric High Speed ZeroED", EntityLocoElectricHighSpeedZeroED.class, ItemIDs.minecartLocoHighSpeedZeroED.item, "electric", 700, 240, 0, 3, 0, 230, 1.2, 0.96, 0, null, 13, -3.4),
				...
				TrainRecord.makeEntry("LUengine", "London Underground Engine", EntityElectricLUengine.class, ItemIDs.minecartLUengine.item, "electric", 600, 100, 0, 10, 0, 100, 0.7, 0.8, 1000, new String[]{"Red", "White", "Black"}, 18, -2.45, "Pack: B.I.P."),
				TrainRecord.makeEntry("LUpassenger", "London Underground Passenger Car", EntityLUpassenger.class, ItemIDs.minecartLUcar.item, "passenger", 0, 0, 1.5, 0, 0, 0, 0, 0, 0, new String[]{"Red", "Black", "Blue"}, 10, 0, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("Class345", "Class 345 Engine", EntityElectricClass345.class, ItemIDs.minecartClass345engine.item, "electric", 1500, 300, 0, 10, 0, 100, 0.9, 0.9, 1000, new String[]{"White", "Red", "Orange", "Pink"}, 18, -3.2, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("locoElectricBNLRV_A", "BNLRV_A", EntityLocoElectricBNLRV_A.class, ItemIDs.minecartBNLRV_A.item, "electric", 550, 70, 3, 10, 0, 0, 0.7, 0.95, 0, new String[]{"Orange", "White", "Yellow", "Grey", "Black"}, 10, -2, "Pack: Trams In Motion"),
				TrainRecord.makeEntry("passengerBNLRV_B", "BNLRV_B", EntityPassengerBNLRV_B.class, ItemIDs.minecartBNLRV_B.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"Orange", "White", "Yellow", "Grey", "Black"}, 10, -2, "Pack: Trams in Motion"),
				TrainRecord.makeEntry("passengerBW305", "BW305", EntityPassengerBW305.class, ItemIDs.minecartPassengerBW305.item, "passenger", 0, 0, 2, 0, 0, 0, 0, 0, 0, new String[]{"Orange", "Blue", "Red"}, 0, 0, "Pack: Trams in Motion"),
				TrainRecord.makeEntry("locoElectricTW305", "TW305", EntityLocoElectricTW305.class, ItemIDs.minecartLocoElectricTW305.item, "electric", 350, 55, 0, 10, 0, 140, 0.75, 0.7, 0, new String[]{"Orange","Blue", "Red"}, 14, -2, "Pack: Trams in Motion"),
				TrainRecord.makeEntry("locoElectricMetro2000", "Metro2000loco", EntityElectricMetro2000Motor.class, ItemIDs.minecartMetro2000Loco.item, "electric", 600, 65, 3, 10, 0, 0, 0.8, 0.9, 0, new String[]{"Blue", "White", "Red"}, 18, -3, "Pack: Metro in Motion"),
				TrainRecord.makeEntry("passengerMetro2000", "Metro2000Passenger", EntityPassengerMetro2000.class, ItemIDs.minecartMetro2000Passenger.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"Blue", "White", "Red"}, 0, -3, "Pack: Metro In Motion"),

				TrainRecord.makeEntry("locoElectricRenfe450Motor", "Loco Electric Renfe 450 Motor", EntityLocoElectricRenfe450Motor.class, ItemIDs.minecartLocoRenfe450Motor.item, "electric", 2900, 140, 0, 3, 0, 230, 1.4, 0.98, 0, new String[]{"Red", "White","Orange"}, 10, -3.7, "Pack: Spanish Pack"),
				TrainRecord.makeEntry("passengerRenfe450Coach", "Passenger Renfe 450 Coach", EntityPassengerRenfe450Coach.class, ItemIDs.minecartPassengerRenfe450Coach.item, "passenger", 0, 0, 2, 0, 0, 0, 0, 0, 0, new String[]{"Red", "White","Orange"}, 10, 0, "Pack: Spanish Pack"),
				TrainRecord.makeEntry("cabooseRenfe450Tail", "Passenger Renfe 450 Tail", EntityCabooseRenfe450Tail.class, ItemIDs.minecartCabooseRenfe450Tail.item, "passenger", 0, 0, 2, 0, 0, 0, 0, 0, 0, new String[]{"Red", "White","Orange"}, 10, -3.7, "Pack: Spanish Pack"),
				...
				TrainRecord.makeEntry("DB143", "Loco Electric DB143", EntityLocoElectricDB143.class, ItemIDs.minecartDB143.item, "electric", 4990, 120, 0, 8, 0, 170, 0.66, 0.96, 8000, null, 15, -3.6, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("EU07", "EU07", EntityLocoElectricEU07.class, ItemIDs.minecartEU07.item, "electric", 2680, 125, 0, 18, 0, 170, 0.66, 0.90, 8000, new String[]{"Blue", "Green", "Lime"}, 15, -3.1, "Pack: ?"),
				...
				TrainRecord.makeEntry("Class158", "Class 158 Engine", EntityLocoDieselClass158.class, ItemIDs.minecartClass158engine.item, "diesel", 400, 146, 3, 10, 0, 100, 0.7, 0.8, 8000, new String[]{"White", "Green", "Cyan", "Blue", "Purple", "Grey", "LightBlue", "Lime", "LightGrey", "Yellow", "Magenta", "Orange", "Red", "Brown"}, 18, -4.82, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class158Coach", "Class 158 Passenger Car", EntityClass158Coach.class, ItemIDs.minecartClass158car.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"White", "Green", "Cyan", "Blue", "Purple", "Grey", "LightBlue", "Lime", "LightGrey", "Yellow", "Magenta", "Orange", "Red", "Brown"}, 0, 0, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("Class153Coach", "Class 153 Coach", EntityPassengerClass153.class, ItemIDs.minecartClass153Coach.item, "passenger", 0, 0, 2.4, 0, 0, 0, 0, 0, 0, new String[]{"LightBlue", "Green", "Grey", "Orange", "Yellow", "Blue", "Lime", "Purple", "LightGrey"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class156", "Class 156 Engine", EntityLocoDieselClass156.class, ItemIDs.minecartClass156engine.item, "diesel", 285, 121, 1.4, 10, 0, 100, 0.8, 0.8, 8000, new String[]{"Black", "Blue", "Cyan", "Green", "Grey", "LightBlue", "LightGrey", "Magenta", "Pink", "Red", "White"}, 18, -3.71, "Pack:  B.I.P."),
				TrainRecord.makeEntry("Class47", "Class 47", EntityLocoDieselClass47.class, ItemIDs.minecartClass47.item, "diesel", 2580, 154, 1.4, 10, 0, 100, 0.7, 0.8, 8000, new String[]{"Black", "Blue", "Green", "Grey", "LightBlue", "LightGrey", "Magenta", "Orange", "Purple", "Red", "White", "Yellow", "Brown", "Cyan", "Pink", "Lime", "Skin17", "Skin18", "Skin19", "Skin20"}, 18, -4.25, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("Class319Engine", "Class 319 Engine", EntityElectricClass319.class, ItemIDs.minecartClass319Engine.item, "electric", 750, 160, 0, 60, 0, 100, 0.7, 0.8, 1000, new String[]{"Red", "Blue", "Cyan", "Green", "Magenta", "White", "Lime", "Purple"}, 18, -3.3, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class319Middle", "Class 319 Passenger Car", EntityPassengerClass319Middle.class, ItemIDs.minecartClass319passenger.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"Red", "Blue", "Cyan", "Green", "Magenta", "White", "Lime", "Purple"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class319Panto", "Class 319 Panto Car", EntityPassengerClass319Panto.class, ItemIDs.minecartClass319panto.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"Red", "Blue", "Cyan", "Green", "Magenta", "White", "Lime", "Purple"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class319Tail", "Class 319 Tail Car", EntityPassengerClass319Tail.class, ItemIDs.minecartClass319Tail.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"Red", "Blue", "Cyan", "Green", "Magenta", "White", "Lime", "Purple"}, 0, 0, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("BR_MK2C_BSO", "BR_MK2C_BSO", EntityPassengerBR_MK2C_BSO.class, ItemIDs.minecartBR_Mk2c_BSO.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"Blue", "Brown", "Cyan", "Grey", "Magenta", "Lime", "Purple", "LightGrey", "LightBlue", "Green", "Yellow"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("BR_MK2C_Coach", "BR_MK2C_Coach", EntityPassengerBR_MK2C_Coach.class, ItemIDs.minecartBR_MK2C_Coach.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"Blue", "Brown", "Cyan", "Grey", "Magenta", "Red", "LightBlue", "Green", "Black", "LightGrey", "Yellow", "Lime", "Pink", "Purple", "Orange"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("BR_MK2F_BSO", "BR_MK2F_BSO", EntityPassengerBR_MK2F_BSO.class, ItemIDs.minecartBR_Mk2f_BSO.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"Blue", "Brown", "Cyan", "Grey", "Magenta", "Red", "Lime", "Purple", "Black", "Orange", "LightGrey", "Green", "Pink"}, 0, 0, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("BR_MK2F_DBSO", "BR_MK2F_DBSO", EntityElectricBR_MK2F_DBSO.class, ItemIDs.minecartBR_Mk2f_DBSO.item, "electric", 1000, 161, 3.3, 60, 0, 0, 0.8, 0.68, 0, new String[]{"Blue", "Cyan", "Grey", "LightBlue", "Purple", "Yellow", "Black", "Red"}, 18, -4.03, "Pack: B.I.P."),
				TrainRecord.makeEntry("BR_MK3_DVT", "BR_MK3_DVT", EntityElectricBR_MK3_DVT.class, ItemIDs.minecartBR_MK3_DVT.item, "electric", 1100, 201, 3, 60, 0, 0, 0.8, 0.685, 0, new String[]{"Blue", "Cyan", "Grey", "LightGrey", "Red", "White", "Yellow", "LightBlue", "Lime"}, 18, -4, "Pack: B.I.P."),
				TrainRecord.makeEntry("BR_MK3_Buffet", "BR_MK3_Buffet", EntityPassengerBR_MK3_Buffet.class, ItemIDs.minecartBR_MK3_Buffet.item, "passenger", 0, 0, 3.2, 0, 0, 0, 0, 0, 0, new String[]{"Blue", "Cyan", "Black", "Brown", "Red", "White", "Pink", "LightGrey", "Green", "Magenta", "Yellow", "LightBlue", "Grey", "Purple", "Orange", "Lime", "Skin17", "Skin18", "Skin19", "Skin20"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("BR_MK3_Coach", "BR_MK3_Coach", EntityPassengerBR_MK3_Coach.class, ItemIDs.minecartBR_MK3_Coach.item, "passenger", 0, 0, 3.2, 0, 0, 0, 0, 0, 0, new String[]{"Blue", "Cyan", "Black", "Brown", "Red", "White", "LightGrey", "Green", "Magenta", "Yellow", "Grey", "Lime", "LightBlue", "Purple", "Skin16", "Skin17", "Skin18", "Skin19", "Skin20", "Skin21", "Skin22", "Skin23", "Skin24", "Skin25", "Skin26"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("BR_MK3a_Coach", "BR_MK3a_Coach", EntityPassengerBR_MK3a_Coach.class, ItemIDs.minecartBR_MK3a_Coach.item, "passenger", 0, 0, 3.2, 0, 0, 0, 0, 0, 0, new String[]{"Purple", "Pink", "Orange", "Magenta", "LightBlue", "Cyan", "Blue", "Yellow", "Brown", "LightGrey"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("BR_MK3_Pantograph", "BR_MK3_Pantograph", EntityPassengerBR_MK3_Pantograph.class, ItemIDs.minecartBR_MK3_Pantograph.item, "passenger", 0, 0, 3.2, 0, 0, 0, 0, 0, 0, new String[]{"Yellow", "Orange", "Blue", "Cyan", "Grey", "Green", "LightBlue", "Lime", "LightGrey", "Magenta"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("BR_MK4_DVT", "BR_MK4_DVT", EntityElectricBR_MK4_DVT.class, ItemIDs.minecartBR_MK4_DVT.item, "electric", 1100, 260, 3, 25, 0, 100, 0.8, 0.685, 1000, new String[]{"Blue", "Red", "White", "Black", "Pink", "LightGrey"}, 18, -4.65, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("Class43", "Class43", EntityLocoDieselClass43.class, ItemIDs.minecartClass43.item, "diesel", 2250, 238, 0, 25, 0, 180, 0.7, 0.74, 13000, new String[]{"White", "Blue", "Brown", "Green", "Red", "Cyan", "LightBlue", "Orange", "Yellow", "Purple", "Pink", "Black", "Grey", "LightGrey", "Magenta", "Lime", "Skin17", "Skin18", "Skin19", "Skin20", "Skin21", "Skin22", "Skin23"}, 0, -3.15, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class90", "Class90", EntityElectricClass90.class, ItemIDs.minecartClass90.item, "electric", 5000, 178, 0, 60, 0, 100, 0.75, 0.74, 1000, new String[]{"Black", "Green", "LightGrey", "Grey", "Pink", "Red", "White", "Magenta", "Brown", "Yellow", "Orange", "Lime"}, 18, -2.73, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("Class321", "Class321", EntityElectricClass321.class, ItemIDs.minecartClass321.item, "electric", 1438, 178, 0, 60, 0, 100, 0.7, 0.75, 1000, new String[]{"Purple", "Grey", "White", "Red", "Green", "Blue", "LightGrey", "Lime", "Yellow"}, 18, -4, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class321Motor", "Class321Motor", EntityPassengerClass321Panto.class, ItemIDs.minecartClass321Panto.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"Purple", "Grey", "White", "Red", "Green", "Blue", "LightGrey", "Lime", "Yellow"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class321Coach", "Class321Coach", EntityPassengerClass321Coach.class, ItemIDs.minecartClass321Coach.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"Purple", "Grey", "White", "Red", "Green", "LightGrey", "Lime", "Yellow"}, 0, 0, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("freight7Plank", "7Plank", EntityFreight7Plank.class, ItemIDs.minecart7Plank.item, "freight", 1, new String[]{"Black", "Blue", "Brown", "Green", "Grey", "LightBlue", "LightGrey", "Lime", "Magenta", "Orange", "Pink", "Red", "Yellow"}, 18, 36, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("BR_Mk1_TSO", "BR_Mk1_TSO", EntityPassengerBR_Mk1_TSO.class, ItemIDs.minecartBR_Mk1_TSO.item, "passenger", 0, 0, 3.5, 0, 0, 0, 0, 0, 0, new String[]{"Magenta", "Pink", "Blue", "Grey", "Brown", "Black", "Cyan", "Lime", "Green", "Yellow", "LightBlue", "Purple", "Red", "Orange", "LightGrey", "White", "Skin17", "Skin20", "Skin21", "Skin22"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("BR_Mk1_Buffet", "BR_Mk1_Buffet", EntityPassengerBR_Mk1_Buffet.class, ItemIDs.minecartBR_Mk1_Buffet.item, "passenger", 0, 0, 3.5, 0, 0, 0, 0, 0, 0, new String[]{"Magenta", "Blue", "Brown", "Cyan", "Green", "Grey", "Red", "LightBlue"}, 0, 0, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("BR_Mk1_TPO_Stowage", "BR_Mk1_TPO_Stowage", EntityFreightBR_Mk1_TPO_Stowage.class, ItemIDs.minecartBR_Mk1_TPO_Stowage.item, "freight", 3.5, new String[]{"Red", "Blue", "Orange"}, 18, 36, "Pack: B.I.P."),
				TrainRecord.makeEntry("NMBS_HLE_18", "NMBS_HLE_18", EntityLocoElectricNMBS_HLE_18.class, ItemIDs.minecartNMBS_HLE_18.item, "electric", 6705, 201, 0, 10, 0, 0, 0.9, 0.79, 0, new String[]{"White", "Grey"}, 10, -3.7, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class175", "Class175", EntityLocoDieselClass175.class, ItemIDs.minecartClass175.item, "diesel", 900, 161, 0, 10, 0, 100, 0.85, 0.72, 15000, new String[]{"Cyan", "Green", "Grey", "LightBlue", "Purple", "White", "LightGrey"}, 18, -4.5, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class175Coach", "Class175Coach", EntityPassengerClass175Coach.class, ItemIDs.minecartClass175Coach.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"Cyan", "Green", "Grey", "LightBlue", "Purple", "White", "LightGrey"}, 0, 0, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("Class404motor", "Class404motor", EntityElectricClass404motor.class, ItemIDs.minecartClass404motor.item, "electric", 900, 131, 0, 50, 0, 100, 0.7, 0.8, 1000, new String[]{"Blue", "Cyan", "Green", "Grey", "LightBlue", "LightGrey", "Lime"}, 18, -4, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class404second", "Class404second", EntityPassengerClass404second.class, ItemIDs.minecartClass404second.item, "passenger", 0, 0, 1.6, 0, 0, 0, 0, 0, 0, new String[]{"Blue", "Cyan", "Green", "LightGrey"}, 18, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class404composite", "Class404composite", EntityPassengerClass404composite.class, ItemIDs.minecartClass404composite.item, "passenger", 0, 0, 1.6, 0, 0, 0, 0, 0, 0, new String[]{"Blue", "Cyan", "Green", "LightGrey"}, 18, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class404tail", "Class404tail", EntityPassengerClass404tail.class, ItemIDs.minecartClass404tail.item, "passenger", 0, 0, 1.8, 0, 0, 0, 0, 0, 0, new String[]{"Blue", "Cyan", "Green", "Grey", "LightBlue", "LightGrey", "Lime"}, 18, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class34", "Class34", EntityLocoDieselClass34.class, ItemIDs.minecartClass34.item, "diesel", 2000, 146, 0, 10, 0, 100, 0.75, 0.9, 6000, new String[]{"Black", "Blue", "Green", "Grey", "Lime", "Orange", "Pink", "Purple", "Red", "White", "LightGrey", "LightBlue", "Yellow", "Cyan", "Magenta", "Brown"}, 18, -3, "Pack: B.I.P."),
				TrainRecord.makeEntry("tankTankerUK", "TankerUK", EntityTankerUK.class, ItemIDs.minecartTanker_UK.item, "tank", 0, 0, 1.4, 0, 0, 0, 0, 0, 45000, new String[]{"Black", "Red", "Green", "Yellow", "White"}, 18, 0, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("RW_Type_2", "RWType2", EntityLocoSteamRWType2.class, ItemIDs.minecartRWType2.item, "steam", 775, 81, 0, 10, 10, 100, 0.7, 0.7, 8000, new String[]{"Black", "Blue", "Brown", "Green", "Grey", "LightGrey", "Lime", "Orange", "Purple", "Pink", "Red", "White"}, 18, -2.4f, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("GWR_42xx", "GWR42xx", EntityLocoSteamGWR42xx.class, ItemIDs.minecartGWR42xx.item, "steam", 1300, 105, 0, 10, 10, 100, 0.7, 0.75, 8200, new String[]{"Black", "Blue", "Brown", "Cyan", "Green", "Grey", "LightBlue", "LightGrey", "Lime", "Orange", "Pink", "Red", "White", "Yellow", "Skin17", "Skin18"}, 18, -2.54f, "Pack: B.I.P."),
				TrainRecord.makeEntry("GWR_72xx", "GWR72xx", EntityLocoSteamGWR72xx.class, ItemIDs.minecartGWR72xx.item, "steam", 1375, 105, 0, 10, 10, 100, 0.7, 0.75, 9000, new String[]{"Black", "Blue", "Green", "Grey", "Lime", "Orange", "Pink"}, 18, -3.5f, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("B80C_A", "B80C_A", EntityElectricB80C_A.class, ItemIDs.minecartB80C_A.item, "electric", 300, 80, 0, 60, 0, 100, 0.7, 0.8, 1000, new String[]{ "Red","Pink","White","Magenta","Yellow","Green"}, 18, -2.4, "Pack: Metro In Motion"),
				TrainRecord.makeEntry("B80C_B", "B80C_B", EntityPassengerB80C_B.class, ItemIDs.minecartB80C_B.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{ "Red","Pink","White","Magenta","Yellow","Green"}, 0, -2.4, "Pack: Metro In Motion"),
				...
				TrainRecord.makeEntry("RefrigeratedVan", "RefrigeratedVan", EntityFreightRefrigeratedVan.class, ItemIDs.minecartRefrigeratedVan.item, "freight", 1.5, new String[]{"Purple", "Blue", "Grey"}, 18, 36, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("BR_Britannia_Class", "BRBritanniaClass", EntityLocoSteamBR_Britannia_Class.class, ItemIDs.minecartBRBritanniaClass.item, "steam", 1950, 161, 0, 10, 10, 100, 0.7, 0.75, 8000, new String[]{"Green", "Black", "Blue", "Grey", "Magenta", "Red", "White", "Yellow", "Cyan", "Orange"}, 18, -4.1f, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class390Front", "Class390Front", EntityElectricClass390.class, ItemIDs.minecartClass390Front.item, "electric", 6840, 260, 0, 60, 0, 100, 0.7, 0.78, 1000, new String[]{"Red", "Blue", "Brown", "Cyan", "Grey", "LightGrey", "Lime", "Magenta", "Orange", "Pink", "Purple", "Black", "White", "Yellow"}, 18, -5.1, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("DuewagGT6ZRLoco", "DuewagGT6ZRLoco", EntityElectricDuewagGT6ZRLoco.class, ItemIDs.minecartDuewagGT6ZRLoco.item, "electric", 250, 70, 0, 20, 0, 100, 0.7, 0.8, 1000, new String[]{"Green", "Grey"}, 18, -1.95, "Pack: Trams In Motion"),
				TrainRecord.makeEntry("DuewagGT6ZRTail", "DuewagGT6ZRTail", EntityPassengerDuewagGT6ZRTail.class, ItemIDs.minecartDuewagGT6ZRTail.item, "passenger", 0, 0, 1, 0, 0, 0, 0, 0, 0, new String[]{"Green", "Grey"}, 18, -1.35, "Pack: Trams In Motion"),
				TrainRecord.makeEntry("M8CLoco", "M8CLoco", EntityElectricM8CLoco.class, ItemIDs.minecartM8CLoco.item, "electric", 250, 70, 0, 20, 0, 100, 0.7, 0.8, 1000, new String[]{"Yellow","Blue","LightBlue","Red", "Grey", "Black", "Orange","LightGrey","Cyan"}, 18, -2.13, "Pack: Trams In Motion"),
				TrainRecord.makeEntry("M8CTail", "M8CTail", EntityPassengerM8CTail.class, ItemIDs.minecartM8CTail.item, "passenger", 0, 0, 1, 0, 0, 0, 0, 0, 0, new String[]{"Yellow","Blue","LightBlue","Red", "Grey", "Black", "Orange","LightGrey","Cyan"}, 18, -2.13, "Pack: Trams In Motion"),
				...
				TrainRecord.makeEntry("passenger10tonBrakeVan", "10tonbrakevan", EntityPassenger10tonBrakeVan.class, ItemIDs.minecartTENtonBrakeVan.item, "passenger", 0, 0, 1, 0, 0, 0, 0, 0, 0, new String[]{"Black", "Orange", "Brown", "Red", "Grey", "White", "LightGrey"}, 18, 0,"Pack: B.I.P."),
				...
				TrainRecord.makeEntry("DuewagGT6ERLoco", "DuewagGT6ERLoco", EntityElectricDuewagGT6ERLoco.class, ItemIDs.minecartDuewagGT6ERLoco.item, "electric", 250, 70, 0, 20, 0, 100, 0.7, 0.8, 1000, new String[]{"Green", "Grey", "Orange", "Red", "Yellow", "Blue","magenta"}, 18, -1.95, "Pack: Trams In Motion"),
				TrainRecord.makeEntry("DuewagGT6ERTail", "DuewagGT6ERTail", EntityPassengerDuewagGT6ERTail.class, ItemIDs.minecartDuewagGT6ERTail.item, "passenger", 0, 0, 1, 0, 0, 0, 0, 0, 0, new String[]{ "Green", "Grey", "Orange", "Red", "Yellow", "Blue","magenta"}, 18, -1.55, "Pack: Trams In Motion"),
				...
				TrainRecord.makeEntry("Class143Front", "Class143front", EntityLocoDieselClass143.class, ItemIDs.minecartClass143Front.item, "diesel", 225, 121, 0, 5, 0, 100, 0.85, 0.9, 7500, new String[]{"Black", "Blue", "Cyan", "Green", "Grey", "LightBlue", "LightGrey", "Lime", "Magenta", "Orange", "Pink", "Purple", "Red", "White", "Yellow"}, 18, -2, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("locoDieselCD754", "CD754", EntityLocoDieselCD754.class, ItemIDs.minecartCD754.item, "diesel", 1974, 101, 0, 60, 0, 170, 0.66, 0.92, 5000, new String[]{"Red"}, 13, -3),
				TrainRecord.makeEntry("Class374Front", "Class374Front", EntityElectricClass374.class, ItemIDs.minecartClass374Front.item, "electric", 5250, 321, 0, 60, 0, 100, 0.7, 0.78, 1000, new String[]{"Blue", "White", "LightBlue", "Pink", "Green"}, 18, -5.1, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("Class387Front", "Class387Front", EntityElectricClass387Front.class, ItemIDs.minecartClass387Front.item, "electric", 2250, 178, 0, 60, 0, 100, 0.7, 0.75, 1000, new String[]{"Cyan", "Pink", "Green", "Red", "Purple", "White", "Lime", "Black", "Blue", "LightBlue", "LightGrey", "Yellow", "Grey", "Orange", "Brown", "Magenta", "Skin17"}, 18, -4, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class387Coach", "Class387Coach", EntityPassengerClass387Coach.class, ItemIDs.minecartClass387Coach.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"Cyan", "Pink", "Green", "Red", "Purple", "White", "Lime", "Black", "Blue", "LightBlue", "LightGrey", "Yellow", "Grey", "Orange", "Brown", "Magenta", "Skin17", "Skin18", "Skin19", "Skin20"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class387Panto", "Class387Panto", EntityPassengerClass387Panto.class, ItemIDs.minecartClass387Panto.item, "passenger", 0, 0, 3.5, 0, 0, 0, 0, 0, 0, new String[]{"Cyan", "Pink", "Green", "Red", "Purple", "White", "Lime", "Black", "Blue", "LightBlue", "LightGrey", "Yellow", "Grey", "Orange", "Brown", "Magenta", "Skin17", "Skin18", "Skin19", "Skin20"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class387Tail", "Class387Tail", EntityPassengerClass387Tail.class, ItemIDs.minecartClass387Tail.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"Cyan", "Pink", "Green", "Red", "Purple", "White", "Lime", "Black", "Blue", "LightBlue", "LightGrey", "Yellow", "Grey", "Orange", "Brown", "Magenta", "Skin17"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class378Front", "Class378Front", EntityElectricClass378Front.class, ItemIDs.minecartClass378Front.item, "electric", 2400, 121, 0, 60, 0, 100, 0.7, 0.75, 1000, new String[]{"Orange", "White"}, 18, -3.9, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("Jacknail", "Jacknail", EntitylocoSteamJacknail.class, ItemIDs.minecartJacknail.item, "steam", 1078, 75, 0, 10, 10, 100, 0.8, 0.6, 15000, new String[]{"Black", "Blue", "Cyan", "Green", "Grey", "LightGrey", "Lime", "Orange", "Yellow"}, 0, -2.45, "Pack: B.I.P."),
				TrainRecord.makeEntry("MRcompound", "MRCompound", EntitylocoSteamMRCompound.class, ItemIDs.minecartMRcompound.item, "steam", 2265, 137, 0, 10, 10, 120, 0.75, 0.75, 7500, new String[]{"Black", "Blue", "Green", "Grey", "Lightblue", "Lightgrey", "Lime", "Magenta", "Orange", "Pink", "Purple", "Red", "White", "Yellow"}, 0, -3, "Pack: B.I.P."),
				TrainRecord.makeEntry("MRcompoundTender", "MRCompoundTender", EntityTenderMRCompound.class, ItemIDs.minecartMRcompoundTender.item, "tender", 0, 0, 4, 0, 0, 0, 0, 0, 4000, new String[]{"Black", "Blue", "Green", "Grey", "Lightblue", "Lightgrey", "Lime", "Magenta", "Orange", "Pink", "Purple", "Red", "White", "Yellow"}, 18, 0, "Water capacity: 4000. B.I.P."),
				TrainRecord.makeEntry("Class142Front", "Class142Front", EntityLocoDieselClass142.class, ItemIDs.minecartClass142Front.item, "diesel", 225, 121, 0, 5, 0, 100, 0.85, 0.9, 7500, new String[]{"Purple", "Cyan", "Blue", "LightBlue", "LightGrey", "Red", "Yellow", "Orange"}, 18, -2.5, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("Bagnall", "Bagnall", EntityLocoDieselBagnall.class, ItemIDs.minecartBagnall.item, "diesel", 90, 100, 0, 5, 0, 100, 0.9, 0.85, 7500, new String[]{"Blue", "Red", "Yellow", "Cyan"}, 18, -2, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class389Front", "Class389Front", EntityElectricClass389Front.class, ItemIDs.minecartClass389Front.item, "electric", 2250, 178, 0, 60, 0, 100, 0.7, 0.75, 1000, new String[]{"Orange", "White", "Purple"}, 18, -4.35, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class389Middle", "Class389Middle", EntityPassengerClass389Middle.class, ItemIDs.minecartClass389Middle.item, "passenger", 0, 0, 3.5, 0, 0, 0, 0, 0, 0, new String[]{"Orange", "Brown", "White", "LightGrey", "Purple", "Magenta", "Black", "Blue", "Green", "Grey", "LightBlue", "Lime", "Pink", "Red", "Yellow", "Skin17"}, 0, 0, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("Class442DTS", "Class442DTS", EntityElectricClass442DTS.class, ItemIDs.minecartClass442DTS.item, "electric", 1610, 175, 0, 60, 0, 100, 0.7, 0.75, 1000, new String[]{"Black", "White", "Lime", "Green", "Orange", "Yellow","Red", "Purple", "Blue", "Lightblue", "Pink"}, 18, -4.34, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class442TS", "Class442TS", EntityPassengerClass442TS.class, ItemIDs.minecartClass442TS.item, "passenger", 0, 0, 3.4, 0, 0, 0, 0, 0, 0, new String[]{"White", "Orange", "Red", "Yellow", "Blue", "Pink"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class442MBLS", "Class442MBLS", EntityPassengerClass442MBLS.class, ItemIDs.minecartClass442MBLS.item, "passenger", 0, 0, 5.1, 0, 0, 0, 0, 0, 0, new String[]{"White", "Orange", "Red", "Yellow", "Blue", "Pink"}, 0, 0, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("M8DNF1Loco", "M8DNF1Loco", EntityElectricM8DNF1Loco.class, ItemIDs.minecartM8DNF1Loco.item, "electric", 250, 70, 0, 20, 0, 100, 0.9, 0.4, 1000, new String[]{"Yellow","Blue","Orange"}, 18, -1.65, "Pack: Trams In Motion"),
				...
				/** TCCE-MLP-1 */
				TrainRecord.makeEntry("Class68", "Class68", EntityLocoDieselClass68.class, ItemIDs.minecartClass68.item, "diesel", 3800, 161, 0, 10, 0, 100, 0.7, 0.75, 8000, new String[]{"Blue", "Purple", "Cyan", "LightBlue", "Grey", "LightGrey"}, 18, -4.25, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("LessCoWagon", "LessCoWagon", EntityFreightLessCoWagon.class, ItemIDs.minecartLessCoWagon.item, "freight", 2.3, new String[]{"Blue", "Cyan", "Grey", "LightBlue", "Orange", "Red", "Yellow", "Brown", "LightGrey", "White"}, 18, 54, "Cargo: any  B.I.P"),
				TrainRecord.makeEntry("BR_MK3_Sleeper", "BR_MK3_Sleeper", EntityPassengerBR_MK3_Sleeper.class, ItemIDs.minecartBR_MK3_Sleeper.item, "passenger", 0, 0, 3.2, 0, 0, 0, 0, 0, 0, new String[]{"Blue", "Brown", "Cyan", "Green", "Pink", "Red", "White", "LightBlue", "Grey", "LightGrey"}, 0, 0, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("GWRMogul", "GWRMogul", EntityLocoSteamGWRMogul.class, ItemIDs.minecartGWRMogul.item, "steam", 950, 121, 3, 10, 10, 100, 0.7, 0.75, 8000, new String[]{"Green", "Black", "Brown", "Grey", "LightBlue", "Lime", "Magenta", "Orange", "Red", "Yellow", "Blue"}, 18, -3.05f, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("Class71", "Class71", EntityLocoElectricClass71.class, ItemIDs.minecartClass71.item, "electric", 2552, 146, 0, 10, 0, 100, 0.6, 0.71, 1000, new String[]{"Black", "Blue", "Brown", "Cyan", "Green", "Grey", "LightBlue", "LightGrey", "Lime", "Magenta", "Orange", "Pink", "Purple", "Red", "White", "Yellow", "Skin17", "Skin18", "Skin19", "Skin20"}, 18, -3, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("Class357", "Class357", EntityElectricClass357.class, ItemIDs.minecartClass357.item, "electric", 2011, 161, 0, 60, 0, 100, 0.72, 0.75, 1000, new String[]{"White", "Purple", "Magenta", "Red"}, 18, -4, "Pack: B.I.P. Use 387 Middle Car"),
				TrainRecord.makeEntry("Class168Clubman", "Class168Clubman", EntityLocoDieselClass168Clubman.class, ItemIDs.minecartClass168Clubman.item, "diesel", 422, 161, 0, 10, 0, 100, 0.82, 0.72, 15000, new String[]{"Grey"}, 18, -4.35, "Pack: B.I.P. Use 389 Middle Car"),
				TrainRecord.makeEntry("Class170", "Class170", EntityLocoDieselClass170.class, ItemIDs.minecartClass170.item, "diesel", 422, 161, 0, 10, 0, 100, 0.82, 0.72, 15000, new String[]{"White", "Brown", "Blue", "Green", "Grey", "LightBlue", "Lime", "Purple", "Red", "Orange", "Cyan", "Yellow"}, 18, -4.35, "Pack: B.I.P. Use 389 Middle Car"),
				TrainRecord.makeEntry("Class172_3", "Class172_3", EntityLocoDieselClass172_3.class, ItemIDs.minecartClass172_3.item, "diesel", 480, 161, 0, 10, 0, 100, 0.82, 0.72, 15000, new String[]{"Green"}, 18, -4.35, "Pack: B.I.P. Use 389 Middle Car"),
				TrainRecord.makeEntry("Class37", "Class37", EntityLocoDieselClass37.class, ItemIDs.minecartClass37.item, "diesel", 1750, 146, 0, 10, 0, 100, 0.7, 0.75, 8000, new String[]{"Orange", "Blue", "Cyan", "Green", "White", "LightBlue", "Black", "Brown", "Grey", "Lime", "LightGrey", "Purple", "Red", "Yellow", "Magenta", "Pink", "Skin17", "Skin18", "Skin19"}, 18, -3.65, "Pack: B.I.P."),
				TrainRecord.makeEntry("GWR14xx", "GWR14xx", EntityLocoSteamGWR14xx.class, ItemIDs.minecartGWR14xx.item, "steam", 450, 118, 2, 10, 10, 100, 0.7, 0.75, 6000, new String[]{"Green", "Orange", "Red", "Yellow", "Blue", "Cyan", "Lime", "Magenta", "Black", "Grey", "LightGrey"}, 18, -2.44f, "Pack: B.I.P."),
				TrainRecord.makeEntry("042Jenny", "042Jenny", EntityLocoSteam042Jenny.class, ItemIDs.minecart042Jenny.item, "steam", 290, 77, 2, 10, 10, 100, 0.74, 0.75, 6000, new String[]{"Blue", "Green", "Red", "Yellow", "Black"}, 18, -2.44f, "Pack: B.I.P."),
				TrainRecord.makeEntry("TGVPowerCar", "TGVPowerCar", EntityElectricTGVPowerCar.class, ItemIDs.minecartTGVPowerCar.item, "electric", 4558, 380, 0, 60, 0, 100, 0.7, 0.79, 1000, new String[]{"Orange", "Brown", "Grey"}, 18, -4.1, "Pack: B.I.P."),
				TrainRecord.makeEntry("TGVR1R8Coach", "TGVR1R8Coach", EntityPassengerTGVR1R8Coach.class, ItemIDs.minecartTGVR1R8Coach.item, "passenger", 0, 0, 3.5, 0, 0, 0, 0, 0, 0, new String[]{"Orange", "Brown", "Grey", "Blue"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("TGVR23567Coach", "TGVR23567Coach", EntityPassengerTGVR23567Coach.class, ItemIDs.minecartTGVR23567Coach.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"Orange", "Brown", "Grey", "Blue"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("TGVR4BarCar", "TGVR4BarCar", EntityPassengerTGVR4BarCar.class, ItemIDs.minecartTGVR4BarCar.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"Orange", "Grey"}, 0, 0, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("PEPDMSO", "PEPDMSO", EntityLocoElectricPEPDMSO.class, ItemIDs.minecartPEPDMSO.item, "electric", 440, 121, 0, 100, 0, 0, 0.75, 0.7, 0, new String[]{"Black", "Blue", "Brown", "Cyan", "Green", "Grey", "LightBlue", "LightGrey", "Lime", "Magenta", "Orange", "Red", "Pink", "White", "Yellow", "Skin17", "Skin18", "Skin19", "Skin20", "Skin21", "Skin22", "Skin24", "Skin25", "Skin26"}, 18, -3.95, "Pack: B.I.P."),
				TrainRecord.makeEntry("PEPTSO", "PEPTSO", EntityPassengerPEPTSO.class, ItemIDs.minecartPEPTSO.item, "passenger", 0, 0, 2.5, 0, 0, 0, 0, 0, 0, new String[]{"Black", "Brown", "Cyan", "LightBlue", "LightGrey", "Lime", "White", "Yellow", "Skin17", "Skin19", "Skin20", "Skin21", "Skin22", "Skin24"}, 0, 0, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("Class400Front", "Class400Front", EntityElectricClass400.class, ItemIDs.minecartClass400Front.item, "electric", 7250, 390, 0, 60, 0, 100, 0.7, 0.78, 1000, new String[]{"White", "Black", "Blue", "Brown", "Green", "Magenta", "Red", "Lime", "Yellow"}, 18, -4.9, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("NERHClass", "NERHClass", EntityLocoSteamNERHClass.class, ItemIDs.minecartNERHClass.item, "steam", 450, 50, 0, 10, 8, 60, 1, 0.6, 5000, new String[]{"Black", "Blue", "Green", "Grey", "Lightblue", "Lightgrey", "Lime", "Orange", "Pink", "Red"}, 18, -1f, "Pack: B.I.P."),
				TrainRecord.makeEntry("V1V3", "V1V3", EntityLocoSteamV1V3.class, ItemIDs.minecartV1V3.item, "steam", 1100, 121, 0, 10, 10, 40, 0.8, 0.75, 20000, new String[]{"Green", "Grey", "Black", "Red", "Cyan", "Blue", "Magenta", "Pink", "Purple"}, 18,-2.5, "Pack: B.I.P."),
				TrainRecord.makeEntry("TeakBCK", "TeakBCK", EntityPassengerTeakBCK.class, ItemIDs.minecartTeakBCK.item, "passenger", 3.5, new String[]{"Brown"}, 18, 0, "Pack:B.I.P."),
