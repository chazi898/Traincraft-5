	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("Class387Coach", "Class387Coach", EntityPassengerClass387Coach.class, ItemIDs.minecartClass387Coach.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"Cyan", "Pink", "Green", "Red", "Purple", "White", "Lime", "Black", "Blue", "LightBlue", "LightGrey", "Yellow", "Grey", "Orange", "Brown", "Magenta", "Skin17", "Skin18"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class387Panto", "Class387Panto", EntityPassengerClass387Panto.class, ItemIDs.minecartClass387Panto.item, "passenger", 0, 0, 3.5, 0, 0, 0, 0, 0, 0, new String[]{"Cyan", "Pink", "Green", "Red", "Purple", "White", "Lime", "Black", "Blue", "LightBlue", "LightGrey", "Yellow", "Grey", "Orange", "Brown", "Magenta", "Skin17", "Skin18"}, 0, 0, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("Class357", "Class357", EntityElectricClass357.class, ItemIDs.minecartClass357.item, "electric", 2011, 161, 0, 60, 0, 100, 0.72, 0.75, 1000, new String[]{"White", "Purple", "Magenta"}, 18, -4, "Pack: B.I.P. Use 387 Middle Car"),
