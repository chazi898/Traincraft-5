	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("BR_Mk1_TPO_Stowage", "BR_Mk1_TPO_Stowage", EntityFreightBR_Mk1_TPO_Stowage.class, ItemIDs.minecartBR_Mk1_TPO_Stowage.item, "freight", 3.5, new String[]{"Red", "Blue"}, 18, 36, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("Class387Front", "Class387Front", EntityElectricClass387Front.class, ItemIDs.minecartClass387Front.item, "electric", 2250, 178, 0, 60, 0, 100, 0.7, 0.75, 1000, new String[]{"Cyan", "Pink", "Green", "Red", "Purple", "White", "Lime", "Black", "Blue", "LightBlue", "LightGrey", "Yellow", "Grey", "Orange", "Brown", "Magenta"}, 18, -4, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class387Coach", "Class387Coach", EntityPassengerClass387Coach.class, ItemIDs.minecartClass387Coach.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"Cyan", "Pink", "Green", "Red", "Purple", "White", "Lime", "Black", "Blue", "LightBlue", "LightGrey", "Yellow", "Grey", "Orange", "Brown", "Magenta", "Skin17", "Skin18", "Skin19"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class387Panto", "Class387Panto", EntityPassengerClass387Panto.class, ItemIDs.minecartClass387Panto.item, "passenger", 0, 0, 3.5, 0, 0, 0, 0, 0, 0, new String[]{"Cyan", "Pink", "Green", "Red", "Purple", "White", "Lime", "Black", "Blue", "LightBlue", "LightGrey", "Yellow", "Grey", "Orange", "Brown", "Magenta", "Skin17", "Skin18", "Skin19"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class387Tail", "Class387Tail", EntityPassengerClass387Tail.class, ItemIDs.minecartClass387Tail.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"Cyan", "Pink", "Green", "Red", "Purple", "White", "Lime", "Black", "Blue", "LightBlue", "LightGrey", "Yellow", "Grey", "Orange", "Brown", "Magenta"}, 0, 0, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("TGVPowerCar", "TGVPowerCar", EntityElectricTGVPowerCar.class, ItemIDs.minecartTGVPowerCar.item, "electric", 4558, 380, 0, 60, 0, 100, 0.7, 0.79, 1000, new String[]{"Orange", "Brown"}, 18, -4.1, "Pack: B.I.P."),
				TrainRecord.makeEntry("TGVR1R8Coach", "TGVR1R8Coach", EntityPassengerTGVR1R8Coach.class, ItemIDs.minecartTGVR1R8Coach.item, "passenger", 0, 0, 3.5, 0, 0, 0, 0, 0, 0, new String[]{"Orange", "Brown"}, 0, 0, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("NERHClass", "NERHClass", EntityLocoSteamNERHClass.class, ItemIDs.minecartNERHClass.item, "steam", 550, 50, 0, 10, 8, 60, 1, 0.6, 5000, new String[]{"Black", "Blue", "Green", "Grey", "Lightblue", "Lightgrey", "Lime", "Orange", "Pink", "Red"}, 18, -1f, "Pack: B.I.P."),
				TrainRecord.makeEntry("V1V3", "V1V3", EntityLocoSteamV1V3.class, ItemIDs.minecartV1V3.item, "steam", 2300, 121, 0, 10, 10, 40, 0.8, 0.75, 20000, new String[]{"Green", "Grey", "Black", "Red", "Cyan", "Blue", "Magenta", "Pink", "Purple"}, 18,-2.5, "Pack: B.I.P."),
