	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("tankTankerUK", "TankerUK", EntityTankerUK.class, ItemIDs.minecartTanker_UK.item, "tank", 0, 0, 6, 0, 0, 0, 0, 0, 45000, new String[]{"Black", "Red", "Green", "Yellow", "White"}, 18, 0, "Pack: B.I.P."),
