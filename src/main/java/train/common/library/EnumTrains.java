	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("LUpassenger", "London Underground Passenger Car", EntityLUpassenger.class, ItemIDs.minecartLUcar.item, "passenger", 0, 0, 1, 0, 0, 0, 0, 0, 0, new String[]{"Red", "Black", "Blue"}, 10, 0, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("BR_MK3_Buffet", "BR_MK3_Buffet", EntityPassengerBR_MK3_Buffet.class, ItemIDs.minecartBR_MK3_Buffet.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"Blue", "Cyan", "Black", "Brown", "Red", "White", "Pink", "LightGrey", "Green", "Magenta", "Yellow", "LightBlue", "Grey", "Purple", "Orange", "Lime", "Skin17", "Skin18", "Skin19"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("BR_MK3_Coach", "BR_MK3_Coach", EntityPassengerBR_MK3_Coach.class, ItemIDs.minecartBR_MK3_Coach.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"Blue", "Cyan", "Black", "Brown", "Red", "White", "Pink", "LightGrey", "Green", "Magenta", "Yellow", "Grey", "Lime", "LightBlue", "Purple", "Skin16", "Skin17", "Skin18", "Skin19", "Skin20", "Skin21", "Skin22", "Skin23", "Skin24"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("BR_MK3a_Coach", "BR_MK3a_Coach", EntityPassengerBR_MK3a_Coach.class, ItemIDs.minecartBR_MK3a_Coach.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"Purple", "Pink", "Orange", "Magenta", "LightBlue", "Cyan", "Blue", "Yellow", "Brown", "LightGrey", "White"}, 0, 0, "Pack: B.I.P."),
