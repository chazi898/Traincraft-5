	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("Class175", "Class175", EntityLocoDieselClass175.class, ItemIDs.minecartClass175.item, "diesel", 900, 161, 0, 10, 0, 100, 0.85, 0.72, 15000, new String[]{"Cyan", "Green", "Grey", "LightBlue", "Purple", "White"}, 18, -4.5, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("Class387Front", "Class387Front", EntityElectricClass387Front.class, ItemIDs.minecartClass387Front.item, "electric", 2250, 178, 0, 60, 0, 100, 0.7, 0.75, 1000, new String[]{"Cyan", "Pink", "Green", "Red", "Purple", "White", "Lime", "Black", "Blue", "LightBlue", "LightGrey", "Yellow", "Grey", "Orange"}, 18, -4, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class387Coach", "Class387Coach", EntityPassengerClass387Coach.class, ItemIDs.minecartClass387Coach.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"Cyan", "Pink", "Green", "Red", "Purple", "White", "Lime", "Black", "Blue", "LightBlue", "LightGrey", "Yellow", "Grey", "Orange", "Brown", "Magenta", "Skin17"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class387Panto", "Class387Panto", EntityPassengerClass387Panto.class, ItemIDs.minecartClass387Panto.item, "passenger", 0, 0, 3.5, 0, 0, 0, 0, 0, 0, new String[]{"Cyan", "Pink", "Green", "Red", "Purple", "White", "Lime", "Black", "Blue", "LightBlue", "LightGrey", "Yellow", "Grey", "Orange", "Brown", "Magenta", "Skin17"}, 0, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class387Tail", "Class387Tail", EntityPassengerClass387Tail.class, ItemIDs.minecartClass387Tail.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"Cyan", "Pink", "Green", "Red", "Purple", "White", "Lime", "Black", "Blue", "LightBlue", "LightGrey", "Yellow", "Grey", "Orange"}, 0, 0, "Pack: B.I.P."),
