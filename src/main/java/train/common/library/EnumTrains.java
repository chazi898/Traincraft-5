	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("Class374Front", "Class374Front", EntityElectricClass374.class, ItemIDs.minecartClass374Front.item, "electric", 5250, 321, 0, 60, 0, 100, 0.7, 0.78, 1000, new String[]{"Blue", "White", "LightBlue", "Pink"}, 18, -5.1, "Pack: B.I.P."),
