	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("locoElectricBNLRV_A", "BNLRV_A", EntityLocoElectricBNLRV_A.class, ItemIDs.minecartBNLRV_A.item, "electric", 550, 70, 3, 10, 0, 0, 0.7, 0.95, 0, new String[]{"Orange", "White", "Yellow", "Grey", "Black"}, 10, -4, "Pack: Trams In Motion"),
