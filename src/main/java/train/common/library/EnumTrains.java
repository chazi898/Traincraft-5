	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("BR_MK3_Sleeper", "BR_MK3_Sleeper", EntityPassengerBR_MK3_Sleeper.class, ItemIDs.minecartBR_MK3_Sleeper.item, "passenger", 0, 0, 3.2, 0, 0, 0, 0, 0, 0, new String[]{"Blue", "Brown", "Cyan", "Green", "Pink", "Red", "White"}, 0, 0, "Pack: B.I.P."),
