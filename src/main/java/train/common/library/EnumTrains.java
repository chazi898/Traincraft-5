	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("Class404second", "Class404second", EntityPassengerClass404second.class, ItemIDs.minecartClass404second.item, "passenger", 0, 0, 16, 0, 0, 0, 0, 0, 0, new String[]{"Blue", "Cyan", "Green", "Grey", "LightBlue", "LightGrey", "Lime"}, 18, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class404composite", "Class404composite", EntityPassengerClass404composite.class, ItemIDs.minecartClass404composite.item, "passenger", 0, 0, 16, 0, 0, 0, 0, 0, 0, new String[]{"Blue", "Cyan", "Green", "Grey", "LightBlue", "LightGrey", "Lime"}, 18, 0, "Pack: B.I.P."),
				TrainRecord.makeEntry("Class404tail", "Class404tail", EntityPassengerClass404tail.class, ItemIDs.minecartClass404tail.item, "passenger", 0, 0, 18, 0, 0, 0, 0, 0, 0, new String[]{"Blue", "Cyan", "Green", "Grey", "LightBlue", "LightGrey", "Lime"}, 18, 0, "Pack: B.I.P."),
