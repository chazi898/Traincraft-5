	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("B80C_A", "B80C_A", EntityElectricB80C_A.class, ItemIDs.minecartB80C_A.item, "electric", 300, 80, 0, 60, 0, 100, 0.7, 0.8, 1000, new String[]{ "Magenta","Red"}, 18, -2.4, "Pack: Metro In Motion"),
				TrainRecord.makeEntry("B80C_B", "B80C_B", EntityPassengerB80C_B.class, ItemIDs.minecartB80C_B.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{ "Magenta","Red"}, 0, -2.4, "Pack: Metro In Motion"),
				...
				TrainRecord.makeEntry("DuewagGT6ERLoco", "DuewagGT6ERLoco", EntityElectricDuewagGT6ERLoco.class, ItemIDs.minecartDuewagGT6ERLoco.item, "electric", 250, 70, 0, 20, 0, 100, 0.7, 0.8, 1000, new String[]{"Green", "Grey", "Orange", "Red", "Yellow", "Blue"}, 18, -1.95, "Pack: Trams In Motion"),
				TrainRecord.makeEntry("DuewagGT6ERTail", "DuewagGT6ERTail", EntityPassengerDuewagGT6ERTail.class, ItemIDs.minecartDuewagGT6ERTail.item, "passenger", 0, 0, 1, 0, 0, 0, 0, 0, 0, new String[]{ "Green", "Grey", "Orange", "Red", "Yellow", "Blue"}, 18, -1.55, "Pack: Trams In Motion"),
