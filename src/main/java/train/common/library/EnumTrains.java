	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("BR_MK3_Sleeper", "BR_MK3_Sleeper", EntityPassengerBR_MK3_Sleeper.class, ItemIDs.minecartBR_MK3_Sleeper.item, "passenger", 0, 0, 3.2, 0, 0, 0, 0, 0, 0, new String[]{"Blue", "Brown", "Cyan", "Green", "Pink", "Red", "White", "LightBlue"}, 0, 0, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("Hornby060E2", "Hornby060E2", EntityLocoSteamHornby060E2.class, ItemIDs.minecartHornby060E2.item, "steam", 550, 121, 3, 10, 10, 100, 0.7, 0.74, 8000, new String[]{"Black", "Blue", "Brown", "White"}, 18, -2.35f, "Pack: B.I.P."),
				TrainRecord.makeEntry("Hornby040E2", "Hornby040E2", EntityLocoSteamHornby040E2.class, ItemIDs.minecartHornby040E2.item, "steam", 540, 121, 2.8, 10, 10, 100, 0.7, 0.74, 8000, new String[]{"Blue", "Black", "Grey", "Red", "Magenta", "Green", "Yellow", "LightBlue", "Pink"}, 18, -2.35f, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("GWR14xx", "GWR14xx", EntityLocoSteamGWR14xx.class, ItemIDs.minecartGWR14xx.item, "steam", 450, 118, 2, 10, 10, 100, 0.7, 0.74, 6000, new String[]{"Green", "Orange", "Red", "Yellow", "Blue", "Cyan", "Lime", "Magenta", "Black", "Grey", "LightGrey"}, 18, -2.44f, "Pack: B.I.P."),
				...
				TrainRecord.makeEntry("TGVPowerCar", "TGVPowerCar", EntityElectricTGVPowerCar.class, ItemIDs.minecartTGVPowerCar.item, "electric", 4558, 301, 0, 60, 0, 100, 0.7, 0.79, 1000, new String[]{"Orange", "Brown"}, 18, -4.1, "Pack: B.I.P."),
