	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("BR_MK3a_Coach", "BR_MK3a_Coach", EntityPassengerBR_MK3a_Coach.class, ItemIDs.minecartBR_MK3a_Coach.item, "passenger", 0, 0, 3, 0, 0, 0, 0, 0, 0, new String[]{"Purple", "Pink", "Orange", "Magenta", "LightBlue", "Cyan", "Blue", "Yellow", "Brown", "LightGrey"}, 0, 0, "Pack: B.I.P."),
