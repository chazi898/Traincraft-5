	...
	public static TrainRecord[] trains() {
		return new TrainRecord[]{
				...
				*/
				...
				TrainRecord.makeEntry("Class158", "Class 158 Engine", EntityLocoDieselClass158.class, ItemIDs.minecartClass158engine.item, "diesel", 350, 146, 3, 10, 0, 100, 0.7, 0.8, 8000, new String[]{"White", "Green", "Cyan", "Blue", "Purple", "Grey", "LightBlue", "Lime", "LightGrey", "Yellow", "Magenta", "Orange", "Red"}, 18, -4.82, "Pack: B.I.P."),
