...
public enum EnumSounds implements TrainSoundRecord {
    ...
    locoSteamPannier(EntityLocoSteamPannier.class, "GWRPannierWhistle", 1.1F, "steam_run", 0.4F, 20, "steam_run", 0.4F, 20, true),
    ...
    locoSteamGWR42xx(EntityLocoSteamGWR42xx.class, "GWRStandardWhistle", 1.3F, "steam_run", 0.4F, 20, "steam_run", 0.4F, 20, true),
    locoSteamGWR72xx(EntityLocoSteamGWR72xx.class, "GWRStandardWhistle", 1.3F, "steam_run", 0.4F, 20, "steam_run", 0.4F, 20, true),
    locoSteamGWR101Class(EntityLocoSteamGWR101Class.class, "GWRPannierWhistle", 1.1F, "steam_run", 0.4F, 20, "steam_run", 0.4F, 20, true),
