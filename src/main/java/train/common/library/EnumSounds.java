...
public enum EnumSounds implements TrainSoundRecord {
    ...
    locoSteamGWR72xx(EntityLocoSteamGWR72xx.class, "GWRStandardWhistle", 1.4F, "steam_run", 0.4F, 20, "steam_run", 0.4F, 20, true),
    locoSteamGWR101Class(EntityLocoSteamGWR101Class.class, "GWRPannierWhistle", 1.2F, "steam_run", 0.4F, 20, "steam_run", 0.4F, 20, true),
    ...
    locoSteamHallClass(EntityLocoSteamHallClass.class, "GWRStandardWhistle", 1.3F, "steam_run", 0.4F, 20, "steam_run", 0.4F, 20, true),
    locoSteamKingClass(EntityLocoSteamKingClass.class, "GWRExpressWhistle", 1F, "steam_run", 0.4F, 20, "steam_run", 0.4F, 20, true),
    ...
    locoAlice(EntityLocoSteamAlice0_4_0.class, "german_steam_horn", 0.8F, "steam_run", 0.4F, 20, "steam_run", 0.4F, 20,
            true),
    locoElectricBR_MK2F_DBSO(EntityElectricBR_MK2F_DBSO.class, "Class321ShortHorn", 1.2F, "", 0F, 0, "", 0F, 0, false),
    locoElectricBR_MK3_DVT(EntityElectricBR_MK3_DVT.class, "Mk4DVTHorn", 1.2F, "", 0F, 0, "", 0F, 0, false),
    locoElectricBR_MK4_DVT(EntityElectricBR_MK4_DVT.class, "Mk4DVTHorn", 1.2F, "", 0F, 0, "", 0F, 0, false),
    ...
    locoBNLRV_A(EntityLocoElectricBNLRV_A.class, "bnlrv_horn", 0.8F, "chme3_idle", 0.65F, 40, "chme3_idle", 0.65F, 40, false),
    ...
    lococlass153(EntityLocoDieselClass153.class, "Class156Horn", 1.4F, "chme3_idle", 0.65F, 40, "chme3_idle", 0.65F, 40, false),
    lococlass175(EntityLocoDieselClass175.class, "Class175Horn", 1.5F, "chme3_idle", 0.65F, 40, "chme3_idle", 0.65F, 40, false),
    lococlass156(EntityLocoDieselClass156.class, "Class156Horn", 1.4F, "chme3_idle", 0.65F, 40, "chme3_idle", 0.65F, 40, false),
    ...
    ElectricClass230Engine(EntityElectricClass230.class, "Class230Horn", 0.8F, "vl10_idle", 0.6F, 50, "vl10_idle", 0.6F, 50, false),
    ...
    Class321(EntityElectricClass321.class, "Class321ShortHorn", 1.1F, "vl10_idle", 0.8F, 10, "vl10_idle", 0.6F, 50, false),
    ...
    Class34(EntityLocoDieselClass34.class, "A4ActuallyWhistling2", 1.3F, "chme3_idle", 0.7F, 40, "chme3_idle", 0.65F, 40, false),
    ...
    GWRMogul(EntityLocoSteamGWRMogul.class, "GWRExpressWhistle", 1F, "steam_run", 0.4F, 20, "steam_run", 0.3F, 20, true),
    Hornby060E2(EntityLocoSteamHornby060E2.class, "ThompsonWhistle", 1.1F, "steam_run", 0.4F, 20, "steam_run", 0.3F, 20, true),
    Hornby040E2(EntityLocoSteamHornby040E2.class, "ThompsonWhistle", 1.1F, "steam_run", 0.4F, 20, "steam_run", 0.3F, 20, true),
    SNCF_BB15000(EntityElectricSNCF_BB15000.class, "BB15000Horn", 1.1F, "vl10_idle", 0.65F, 10, "vl10_idle", 0.6F, 50, false),
    MGTKLoco(EntityElectricMGTKLoco.class, "tram_bell", 1F, "vl10_idle", 0.6F, 50, "vl10_idle", 0.6F, 50, false),
    B80D_A(EntityElectricB80D_A.class, "tram_bell", 1F, "mg_run", 0.6F, 50, "mg_run", 0.6F, 50, false),
    Class20(EntityLocoDieselClass20.class, "Class20Horn", 1.2F, "Class20Thrash", 0.7F, 52, "chme3_idle",0.6F, 50, false),
    ...
    Class37(EntityLocoDieselClass37.class, "Class37Horn", 1.3F, "Class37Thrash", 0.9F, 45, "Class37Idle", 0.4F, 45, false),
    ...
    Class17(EntityLocoDieselClass17.class, "Class17Horn", 1F, "Class17Thrash", 0.95F, 45, "Class17Thrash", 0.28F, 55, false),
