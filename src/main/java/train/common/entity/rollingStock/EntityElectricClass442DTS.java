...
public class EntityElectricClass442DTS extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityElectricClass442DTS(World world) {
        super(world);

    }

    public EntityElectricClass442DTS(World world, double d, double d1, double d2) {
        this(world);
