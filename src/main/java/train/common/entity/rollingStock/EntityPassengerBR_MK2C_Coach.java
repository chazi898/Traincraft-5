...
public class EntityPassengerBR_MK2C_Coach extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerBR_MK2C_Coach(World world) {
        super(world);
    }

    public EntityPassengerBR_MK2C_Coach(World world, double d, double d1, double d2){
        this(world);
