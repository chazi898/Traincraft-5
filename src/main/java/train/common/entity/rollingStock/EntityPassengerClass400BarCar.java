...
public class EntityPassengerClass400BarCar extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerClass400BarCar(World world) {
        super(world);
    }

    public EntityPassengerClass400BarCar(World world, double d, double d1, double d2){
        this(world);
