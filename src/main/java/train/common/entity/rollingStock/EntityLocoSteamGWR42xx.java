...
public class EntityLocoSteamGWR42xx extends SteamTrain {
    public EntityLocoSteamGWR42xx(World world) {
    ...
    public EntityLocoSteamGWR42xx(World world, double d, double d1, double d2) {
        this(world);
