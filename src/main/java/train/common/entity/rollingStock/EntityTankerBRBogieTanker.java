...
public class EntityTankerBRBogieTanker extends LiquidTank {
	public int freightInventorySize;
	public EntityTankerBRBogieTanker(World world) {
		super(world);
		initFreightWater();
	}
	...
	public EntityTankerBRBogieTanker(World world, double d, double d1, double d2) {
		this(world);
