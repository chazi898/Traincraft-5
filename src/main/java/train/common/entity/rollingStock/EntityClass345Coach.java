...
public class EntityClass345Coach extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityClass345Coach(World world) {
        super(world);
    }

    public EntityClass345Coach(World world, double d, double d1, double d2){
        this(world);
