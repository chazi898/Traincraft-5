...
public class EntityTenderBR1 extends Tender implements IInventory  {
    public int freightInventorySize;
    public int numFreightSlots;

    public EntityTenderBR1(World world) {
    ...
    public EntityTenderBR1(World world, double d, double d1, double d2) {
        this(world);
