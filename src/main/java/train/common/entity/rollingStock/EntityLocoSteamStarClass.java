...
public class EntityLocoSteamStarClass extends SteamTrain {
	public EntityLocoSteamStarClass(World world) {
	...
	public EntityLocoSteamStarClass(World world, double d, double d1, double d2) {
		this(world);
