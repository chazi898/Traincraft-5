...
public class EntityLocoSteamMallardA4 extends SteamTrain {
	...
	public EntityLocoSteamMallardA4(World world, double d, double d1, double d2) {
		this(world);
	...
	public void updateRiderPosition() {
		...
		*/
		...
		riddenByEntity.setPosition(posX, posY + getMountedYOffset() + riddenByEntity.getYOffset() +0.35, posZ);
	}
