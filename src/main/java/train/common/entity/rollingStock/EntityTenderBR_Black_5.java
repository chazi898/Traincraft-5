...
public class EntityTenderBR_Black_5 extends Tender implements IInventory  {
    public int freightInventorySize;
    public int numFreightSlots;

    public EntityTenderBR_Black_5(World world) {
    ...
    public EntityTenderBR_Black_5(World world, double d, double d1, double d2) {
        this(world);
