...
public class EntityLocoSteamHornby040E2 extends SteamTrain {
    public EntityLocoSteamHornby040E2(World world) {
    ...
    public EntityLocoSteamHornby040E2(World world, double d, double d1, double d2) {
        this(world);
