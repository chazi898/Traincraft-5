...
public class EntityPassengerClass319Middle extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerClass319Middle(World world) {
        super(world);
    }

    public EntityPassengerClass319Middle(World world, double d, double d1, double d2){
        this(world);
