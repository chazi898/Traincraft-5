...
public class EntityPassengerClass205tail extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerClass205tail(World world) {
        super(world);
    }

    public EntityPassengerClass205tail(World world, double d, double d1, double d2){
        this(world);
