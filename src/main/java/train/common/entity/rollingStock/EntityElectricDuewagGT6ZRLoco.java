...
public class EntityElectricDuewagGT6ZRLoco extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityElectricDuewagGT6ZRLoco(World world) {
        super(world);

    }

    public EntityElectricDuewagGT6ZRLoco(World world, double d, double d1, double d2) {
        this(world);
