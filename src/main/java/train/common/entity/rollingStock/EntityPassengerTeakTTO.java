...
public class EntityPassengerTeakTTO extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerTeakTTO(World world) {
        super(world);
    }

    public EntityPassengerTeakTTO(World world, double d, double d1, double d2){
        this(world);
    ...
    @Override
    public float getOptimalDistance(EntityMinecart cart) { return 2.68F;}
    @Override
