...
public class EntityElectricClass91 extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityElectricClass91(World world) {
        super(world);

    }

    public EntityElectricClass91(World world, double d, double d1, double d2) {
        this(world);
