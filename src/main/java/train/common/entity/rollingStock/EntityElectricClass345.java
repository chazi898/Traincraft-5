...
public class EntityElectricClass345 extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityElectricClass345(World world) {
        super(world);

    }

    public EntityElectricClass345(World world, double d, double d1, double d2) {
        this(world);
