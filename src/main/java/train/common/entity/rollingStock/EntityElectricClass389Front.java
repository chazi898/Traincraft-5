...
public class EntityElectricClass389Front extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityElectricClass389Front(World world) {
        super(world);

    }

    public EntityElectricClass389Front(World world, double d, double d1, double d2) {
        this(world);
