...
public class EntityTenderStarClass extends Tender implements IInventory  {
	public int freightInventorySize;
	public int numFreightSlots;

	public EntityTenderStarClass(World world) {
	...
	public EntityTenderStarClass(World world, double d, double d1, double d2) {
		this(world);
