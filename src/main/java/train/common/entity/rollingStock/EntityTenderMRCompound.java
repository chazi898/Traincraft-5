...
public class EntityTenderMRCompound extends Tender implements IInventory  {
    ...
    public EntityTenderMRCompound(World world, double d, double d1, double d2) {
        this(world);
