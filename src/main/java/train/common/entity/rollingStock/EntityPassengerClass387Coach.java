...
public class EntityPassengerClass387Coach extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerClass387Coach(World world) {
        super(world);
    }

    public EntityPassengerClass387Coach(World world, double d, double d1, double d2){
        this(world);
