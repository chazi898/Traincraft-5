...
public class EntitylocoSteamJacknail  extends SteamTrain {
    public EntitylocoSteamJacknail (World world) {
    ...
    public EntitylocoSteamJacknail (World world, double d, double d1, double d2) {
        this(world);
