...
public class EntityLocoDieselDHP1 extends DieselTrain {
    public EntityLocoDieselDHP1(World world) {
        super(world, LiquidManager.dieselFilter());
        initLoco();

    }
    public EntityLocoDieselDHP1(World world, double d, double d1, double d2){
        this(world);
