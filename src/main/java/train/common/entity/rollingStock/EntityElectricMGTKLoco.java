...
public class EntityElectricMGTKLoco extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityElectricMGTKLoco(World world) {
        super(world);

    }

    public EntityElectricMGTKLoco(World world, double d, double d1, double d2) {
        this(world);
