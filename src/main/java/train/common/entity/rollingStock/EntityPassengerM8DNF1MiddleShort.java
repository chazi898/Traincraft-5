...
public class EntityPassengerM8DNF1MiddleShort extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerM8DNF1MiddleShort(World world) {
        super(world);
    }

    public EntityPassengerM8DNF1MiddleShort(World world, double d, double d1, double d2){
        this(world);
