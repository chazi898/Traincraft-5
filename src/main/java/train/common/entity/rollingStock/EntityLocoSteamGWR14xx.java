...
public class EntityLocoSteamGWR14xx extends SteamTrain {
    public EntityLocoSteamGWR14xx(World world) {
    ...
    public EntityLocoSteamGWR14xx(World world, double d, double d1, double d2) {
        this(world);
