...
public class EntityPassengerClass378Middle extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerClass378Middle(World world) {
        super(world);
    }

    public EntityPassengerClass378Middle(World world, double d, double d1, double d2){
        this(world);
