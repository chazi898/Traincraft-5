...
public class EntityLocoElectricBapEF1B extends ElectricTrain {
    public EntityLocoElectricBapEF1B(World world) {
        super(world);
    }

    public EntityLocoElectricBapEF1B(World world, double d, double d1, double d2) {
        this(world);
