...
public class EntityElectricBR_MK2F_DBSO extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityElectricBR_MK2F_DBSO(World world) {
        super(world);

    }

    public EntityElectricBR_MK2F_DBSO(World world, double d, double d1, double d2) {
        this(world);
