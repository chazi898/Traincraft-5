...
public class EntityElectricSNCF_BB15000 extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityElectricSNCF_BB15000(World world) {
        super(world);

    }

    public EntityElectricSNCF_BB15000(World world, double d, double d1, double d2) {
        this(world);
