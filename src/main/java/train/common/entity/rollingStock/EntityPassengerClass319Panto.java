...
public class EntityPassengerClass319Panto extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerClass319Panto(World world) {
        super(world);
    }

    public EntityPassengerClass319Panto(World world, double d, double d1, double d2){
        this(world);
