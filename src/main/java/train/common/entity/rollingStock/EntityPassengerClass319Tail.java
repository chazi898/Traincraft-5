...
public class EntityPassengerClass319Tail extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerClass319Tail(World world) {
        super(world);
    }

    public EntityPassengerClass319Tail(World world, double d, double d1, double d2){
        this(world);
