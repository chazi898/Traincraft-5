...
public class EntityLocoSteamBH040 extends SteamTrain {
    public EntityLocoSteamBH040(World world) {
    ...
    public EntityLocoSteamBH040(World world, double d, double d1, double d2) {
        this(world);
    ...
    public String getInventoryName() {
        return "Black Hawthorne Leslie 0-4-0";
    }
