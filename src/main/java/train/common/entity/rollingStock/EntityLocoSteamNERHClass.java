...
public class EntityLocoSteamNERHClass extends SteamTrain {
    public EntityLocoSteamNERHClass(World world) {
    ...
    public EntityLocoSteamNERHClass(World world, double d, double d1, double d2) {
        this(world);
