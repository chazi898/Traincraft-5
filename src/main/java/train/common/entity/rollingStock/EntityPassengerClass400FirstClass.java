...
public class EntityPassengerClass400FirstClass extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerClass400FirstClass(World world) {
        super(world);
    }

    public EntityPassengerClass400FirstClass(World world, double d, double d1, double d2){
        this(world);
