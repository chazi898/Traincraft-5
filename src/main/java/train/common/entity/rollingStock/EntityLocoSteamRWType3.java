...
public class EntityLocoSteamRWType3 extends SteamTrain {
    public EntityLocoSteamRWType3(World world) {
    ...
    public EntityLocoSteamRWType3(World world, double d, double d1, double d2) {
        this(world);
