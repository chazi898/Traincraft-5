...
public class EntityLocoSteamLMS_Duchess_Class extends SteamTrain {
    public EntityLocoSteamLMS_Duchess_Class(World world) {
    ...
    public EntityLocoSteamLMS_Duchess_Class(World world, double d, double d1, double d2) {
        this(world);
