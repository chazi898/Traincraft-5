...
public class EntityElectricTGVPowerCar extends ElectricTrain {
    ...
    public EntityElectricTGVPowerCar(World world) {
        super(world);

    }

    public EntityElectricTGVPowerCar(World world, double d, double d1, double d2) {
        this(world);
