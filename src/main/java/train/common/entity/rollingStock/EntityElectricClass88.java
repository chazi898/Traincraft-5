...
public class EntityElectricClass88 extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityElectricClass88(World world) {
        super(world);

    }

    public EntityElectricClass88(World world, double d, double d1, double d2) {
        this(world);
