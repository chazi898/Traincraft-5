...
public class EntityLocoElectricClass71 extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityLocoElectricClass71(World world) {
        super(world);

    }

    public EntityLocoElectricClass71(World world, double d, double d1, double d2) {
        this(world);
