...
public class EntityLocoSteam042Jenny extends SteamTrain {
    public EntityLocoSteam042Jenny(World world) {
    ...
    public EntityLocoSteam042Jenny(World world, double d, double d1, double d2) {
        this(world);
