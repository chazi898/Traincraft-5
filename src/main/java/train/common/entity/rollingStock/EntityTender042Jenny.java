...
public class EntityTender042Jenny extends Tender implements IInventory  {
    public int freightInventorySize;
    public int numFreightSlots;

    public EntityTender042Jenny(World world) {
    ...
    public EntityTender042Jenny(World world, double d, double d1, double d2) {
        this(world);
