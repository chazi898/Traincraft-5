...
public class EntityElectricB80C_A extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityElectricB80C_A(World world) {
        super(world);

    }

    public EntityElectricB80C_A(World world, double d, double d1, double d2) {
        this(world);
