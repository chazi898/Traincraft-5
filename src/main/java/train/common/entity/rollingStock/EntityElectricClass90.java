...
public class EntityElectricClass90 extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityElectricClass90(World world) {
        super(world);

    }

    public EntityElectricClass90(World world, double d, double d1, double d2) {
        this(world);
