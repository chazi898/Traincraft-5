...
public class EntityPassengerTeakCK extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerTeakCK(World world) {
        super(world);
    }

    public EntityPassengerTeakCK(World world, double d, double d1, double d2){
        this(world);
