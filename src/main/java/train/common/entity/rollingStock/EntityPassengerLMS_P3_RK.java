...
public class EntityPassengerLMS_P3_RK extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerLMS_P3_RK(World world) {
        super(world);
    }

    public EntityPassengerLMS_P3_RK(World world, double d, double d1, double d2){
        this(world);
    ...
    @Override
    public float getOptimalDistance(EntityMinecart cart) { return 2.47F;}
    @Override
