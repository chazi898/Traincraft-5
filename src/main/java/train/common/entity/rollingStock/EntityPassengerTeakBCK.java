...
public class EntityPassengerTeakBCK extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerTeakBCK(World world) {
        super(world);
    }

    public EntityPassengerTeakBCK(World world, double d, double d1, double d2){
        this(world);
