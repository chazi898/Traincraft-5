...
public class EntityPassengerClass442TS extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerClass442TS(World world) {
        super(world);
    }

    public EntityPassengerClass442TS(World world, double d, double d1, double d2){
        this(world);
