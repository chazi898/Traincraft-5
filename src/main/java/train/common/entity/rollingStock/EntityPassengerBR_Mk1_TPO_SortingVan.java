...
public class EntityPassengerBR_Mk1_TPO_SortingVan extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerBR_Mk1_TPO_SortingVan(World world) {
        super(world);
    }

    public EntityPassengerBR_Mk1_TPO_SortingVan(World world, double d, double d1, double d2){
        this(world);
    ...
    @Override
    public float getOptimalDistance(EntityMinecart cart) { return 2.69F;}
    @Override
