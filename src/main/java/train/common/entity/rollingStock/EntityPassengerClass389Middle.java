...
public class EntityPassengerClass389Middle extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerClass389Middle(World world) {
        super(world);
    }

    public EntityPassengerClass389Middle(World world, double d, double d1, double d2){
        this(world);
