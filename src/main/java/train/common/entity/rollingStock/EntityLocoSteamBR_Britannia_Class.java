...
public class EntityLocoSteamBR_Britannia_Class extends SteamTrain {
    public EntityLocoSteamBR_Britannia_Class(World world) {
    ...
    public EntityLocoSteamBR_Britannia_Class(World world, double d, double d1, double d2) {
        this(world);
