...
public class EntityPassengerFGV4300Coach extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerFGV4300Coach(World world) {
        super(world);
    }

    public EntityPassengerFGV4300Coach(World world, double d, double d1, double d2){
        this(world);
