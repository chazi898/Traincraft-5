...
public class EntityFreightBapDOT11129080 extends LiquidTank {
    public int freightInventorySize;

    public EntityFreightBapDOT11129080(World world) {
        super(world);
        initFreightWater();
    }

    public EntityFreightBapDOT11129080(World world, double d, double d1, double d2){
        this(world);
