...
public class EntityElectricDuewagGT6ERLoco extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityElectricDuewagGT6ERLoco(World world) {
        super(world);

    }

    public EntityElectricDuewagGT6ERLoco(World world, double d, double d1, double d2) {
        this(world);
