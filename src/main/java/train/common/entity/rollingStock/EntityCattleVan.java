...
public class EntityCattleVan extends EntityRollingStock implements IPassenger {
	public EntityCattleVan(World world) {
		super(world);
	}

	public EntityCattleVan(World world, double d, double d1, double d2) {
		this(world);
