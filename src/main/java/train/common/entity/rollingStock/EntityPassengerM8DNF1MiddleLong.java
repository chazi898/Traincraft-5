...
public class EntityPassengerM8DNF1MiddleLong extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerM8DNF1MiddleLong(World world) {
        super(world);
    }

    public EntityPassengerM8DNF1MiddleLong(World world, double d, double d1, double d2){
        this(world);
