...
public class EntityTenderLMS_10Ton extends Tender implements IInventory  {
    public int freightInventorySize;
    public int numFreightSlots;

    public EntityTenderLMS_10Ton(World world) {
    ...
    public EntityTenderLMS_10Ton(World world, double d, double d1, double d2) {
        this(world);
