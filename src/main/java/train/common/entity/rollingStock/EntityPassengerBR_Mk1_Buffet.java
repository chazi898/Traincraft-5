...
public class EntityPassengerBR_Mk1_Buffet extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerBR_Mk1_Buffet(World world) {
        super(world);
    }

    public EntityPassengerBR_Mk1_Buffet(World world, double d, double d1, double d2){
        this(world);
