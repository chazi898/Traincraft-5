...
public class EntityElectricDuewagT4ER extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityElectricDuewagT4ER(World world) {
        super(world);

    }

    public EntityElectricDuewagT4ER(World world, double d, double d1, double d2) {
        this(world);
