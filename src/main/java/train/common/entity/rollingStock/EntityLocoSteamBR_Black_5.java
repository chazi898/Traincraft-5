...
public class EntityLocoSteamBR_Black_5 extends SteamTrain {
    public EntityLocoSteamBR_Black_5(World world) {
    ...
    public EntityLocoSteamBR_Black_5(World world, double d, double d1, double d2) {
        this(world);
