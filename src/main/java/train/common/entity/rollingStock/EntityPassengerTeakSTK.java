...
public class EntityPassengerTeakSTK extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerTeakSTK(World world) {
        super(world);
    }

    public EntityPassengerTeakSTK(World world, double d, double d1, double d2){
        this(world);
