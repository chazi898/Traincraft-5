...
public class EntityPassengerClass387Panto extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerClass387Panto(World world) {
        super(world);
    }

    public EntityPassengerClass387Panto(World world, double d, double d1, double d2){
        this(world);
