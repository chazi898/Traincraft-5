...
public class EntityPassengerClass387Tail extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerClass387Tail(World world) {
        super(world);
    }

    public EntityPassengerClass387Tail(World world, double d, double d1, double d2){
        this(world);
