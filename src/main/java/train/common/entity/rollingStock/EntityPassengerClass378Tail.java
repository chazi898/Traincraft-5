...
public class EntityPassengerClass378Tail extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerClass378Tail(World world) {
        super(world);
    }

    public EntityPassengerClass378Tail(World world, double d, double d1, double d2){
        this(world);
