...
public class EntityFreightBapDOT11111000 extends LiquidTank {
    public int freightInventorySize;

    public EntityFreightBapDOT11111000(World world) {
        super(world);
        initFreightWater();
    }
    ...
    public EntityFreightBapDOT11111000(World world, double d, double d1, double d2){
        this(world);
