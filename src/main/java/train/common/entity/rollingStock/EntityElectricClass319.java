...
public class EntityElectricClass319 extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityElectricClass319(World world) {
        super(world);

    }

    public EntityElectricClass319(World world, double d, double d1, double d2) {
        this(world);
