...
public class EntityLocoSteamLMS_Streamlined_Coronation extends SteamTrain {
    public EntityLocoSteamLMS_Streamlined_Coronation(World world) {
    ...
    public EntityLocoSteamLMS_Streamlined_Coronation(World world, double d, double d1, double d2) {
        this(world);
    ...
    public String getInventoryName() {
        return "LMS Streamlined Coronation";
    }
