...
public class EntityPassengerClass442MBLS extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerClass442MBLS(World world) {
        super(world);
    }

    public EntityPassengerClass442MBLS(World world, double d, double d1, double d2){
        this(world);
