...
public class EntityElectricInterurbanSeries100 extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityElectricInterurbanSeries100(World world) {
        super(world);

    }

    public EntityElectricInterurbanSeries100(World world, double d, double d1, double d2) {
        this(world);
