...
public class EntityLocoElectricBapEF1 extends ElectricTrain {
    public EntityLocoElectricBapEF1(World world) {
        super(world);
    }

    public EntityLocoElectricBapEF1(World world, double d, double d1, double d2) {
        this(world);
