...
public class EntityLocoSteamV1V3 extends SteamTrain {
    public EntityLocoSteamV1V3(World world) {
    ...
    public EntityLocoSteamV1V3(World world, double d, double d1, double d2) {
        this(world);
