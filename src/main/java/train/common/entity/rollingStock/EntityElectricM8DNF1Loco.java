...
public class EntityElectricM8DNF1Loco extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityElectricM8DNF1Loco(World world) {
        super(world);

    }

    public EntityElectricM8DNF1Loco(World world, double d, double d1, double d2) {
        this(world);
