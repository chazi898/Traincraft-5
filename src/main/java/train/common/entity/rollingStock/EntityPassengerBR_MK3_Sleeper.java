...
public class EntityPassengerBR_MK3_Sleeper extends EntityRollingStock implements IPassenger {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityPassengerBR_MK3_Sleeper(World world) {
        super(world);
    }

    public EntityPassengerBR_MK3_Sleeper(World world, double d, double d1, double d2){
        this(world);
