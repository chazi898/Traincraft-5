...
public class EntityLocoSteamHornby060E2 extends SteamTrain {
    public EntityLocoSteamHornby060E2(World world) {
    ...
    public EntityLocoSteamHornby060E2(World world, double d, double d1, double d2) {
        this(world);
