...
public class EntityTenderRWType2 extends Tender implements IInventory  {
    ...
    public EntityTenderRWType2(World world, double d, double d1, double d2) {
        this(world);
