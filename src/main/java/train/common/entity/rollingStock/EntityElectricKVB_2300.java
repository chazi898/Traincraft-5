...
public class EntityElectricKVB_2300 extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityElectricKVB_2300(World world) {
        super(world);

    }

    public EntityElectricKVB_2300(World world, double d, double d1, double d2) {
        this(world);
