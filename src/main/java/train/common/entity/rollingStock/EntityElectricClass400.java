...
public class EntityElectricClass400 extends ElectricTrain {
    //public TiltingHandler tiltingHandler = new TiltingHandler(7);

    public EntityElectricClass400(World world) {
        super(world);

    }

    public EntityElectricClass400(World world, double d, double d1, double d2) {
        this(world);
    ...
    @Override
    public TrainSound getBell(){return new TrainSound("tc:Class400DoorClosing",0.45f,1,1);}
