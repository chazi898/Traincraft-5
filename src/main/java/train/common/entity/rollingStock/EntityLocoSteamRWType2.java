...
public class EntityLocoSteamRWType2 extends SteamTrain {
    public EntityLocoSteamRWType2(World world) {
    ...
    public EntityLocoSteamRWType2(World world, double d, double d1, double d2) {
        this(world);
