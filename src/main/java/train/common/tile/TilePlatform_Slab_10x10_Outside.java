...
public class TilePlatform_Slab_10x10_Outside extends TileRenderFacing {

	public TilePlatform_Slab_10x10_Outside() {
		//facingMeta = this.getBlockMetadata(); // Changed from this.blockMetadata to the method call to avoid receiving invalid Metadata.
	}

	public TilePlatform_Slab_10x10_Outside(int meta){
