...
import train.common.blocks.blockSwitch.BlockBR_UK_SpeedSign_Right;

public class TileBR_UK_SpeedSign_Right extends TileRenderFacing {

	private int skinstate;

	public TileBR_UK_SpeedSign_Right(){
	}
	public TileBR_UK_SpeedSign_Right(BlockBR_UK_SpeedSign_Right block){
		host = block;
	}
