...
public class TileBR_UK_SpeedSign_DoubleLeft extends TileRenderFacing {

	private int skinstate;

	public TileBR_UK_SpeedSign_DoubleLeft(){
	}
	public TileBR_UK_SpeedSign_DoubleLeft(BlockBR_UK_SpeedSign_DoubleLeft block){
		host = block;
	}
