...
import train.common.blocks.blockSwitch.BlockBR_UK_SpeedSign_Left;

public class TileBR_UK_SpeedSign_Left extends TileRenderFacing {

	private int skinstate;

	public TileBR_UK_SpeedSign_Left(){
	}
	public TileBR_UK_SpeedSign_Left(BlockBR_UK_SpeedSign_Left block){
		host = block;
	}
