...
import train.common.blocks.blockSwitch.BlockTram_Platform_Fenced;

public class TileTram_Platform_Fenced extends TileRenderFacing {

	private int skinstate;

	public TileTram_Platform_Fenced(){
	}
	public TileTram_Platform_Fenced(BlockTram_Platform_Fenced block){
		host = block;
	}
