...
import train.common.blocks.blockSwitch.BlockBR_UK_SpeedSign_Cutout;

public class TileBR_UK_SpeedSign_Cutout extends TileRenderFacing {

	private int skinstate;

	public TileBR_UK_SpeedSign_Cutout(){
	}
	public TileBR_UK_SpeedSign_Cutout(BlockBR_UK_SpeedSign_Cutout block){
		host = block;
	}
