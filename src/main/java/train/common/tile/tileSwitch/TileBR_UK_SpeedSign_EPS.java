...
public class TileBR_UK_SpeedSign_EPS extends TileRenderFacing {

	private int skinstate;

	public TileBR_UK_SpeedSign_EPS(){
	}
	public TileBR_UK_SpeedSign_EPS(BlockBR_UK_SpeedSign_EPS block){
		host = block;
	}
