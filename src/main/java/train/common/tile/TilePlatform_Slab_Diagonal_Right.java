...
public class TilePlatform_Slab_Diagonal_Right extends TileRenderFacing {

	public TilePlatform_Slab_Diagonal_Right() {
		//facingMeta = this.getBlockMetadata(); // Changed from this.blockMetadata to the method call to avoid receiving invalid Metadata.
	}

	public TilePlatform_Slab_Diagonal_Right(int meta){
