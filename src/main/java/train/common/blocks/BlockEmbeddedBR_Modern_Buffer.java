...
public class BlockEmbeddedBR_Modern_Buffer extends BlockContainer {

	private IIcon texture;

	public BlockEmbeddedBR_Modern_Buffer() {
		super(Material.iron);
	...
	public void onBlockPlacedBy(World world, int par2, int par3, int par4, EntityLivingBase living, ItemStack stack) {
		TileEmbeddedBR_Modern_Buffer te = (TileEmbeddedBR_Modern_Buffer) world.getTileEntity(par2, par3, par4);
		if (te != null) {
	...
	@Override
	public TileEntity createTileEntity(World world, int metadata) { return new TileEmbeddedBR_Modern_Buffer(); }

	@Override
	public TileEntity createNewTileEntity(World world, int meta) {
		return new TileEmbeddedBR_Modern_Buffer(meta);
	}
