...
public class BlockPlatform_Slab_10x10_Outside extends BlockContainer {

	private IIcon texture;

	public BlockPlatform_Slab_10x10_Outside() {
		super(Material.iron);
	...
	public void onBlockPlacedBy(World world, int par2, int par3, int par4, EntityLivingBase living, ItemStack stack) {
		TilePlatform_Slab_10x10_Outside te = (TilePlatform_Slab_10x10_Outside) world.getTileEntity(par2, par3, par4);
		if (te != null) {
	...
	@Override
	public TileEntity createTileEntity(World world, int metadata) { return new TilePlatform_Slab_10x10_Outside(); }

	@Override
	public TileEntity createNewTileEntity(World world, int meta) {
		return new TilePlatform_Slab_10x10_Outside(meta);
	}
}