...
public class BlockBR_UK_Whistleboard extends BlockDynamic {
	private IIcon texture;
	private int skinstate = 0;

	public BlockBR_UK_Whistleboard() {
	...
	public void onBlockPlacedBy(World world, int i, int j, int k, EntityLivingBase entityliving, ItemStack stack) {
		...
		TileBR_UK_Whistleboard te = (TileBR_UK_Whistleboard) world.getTileEntity(i, j, k);
		if (te != null) {
	...
	public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_) {
		TileBR_UK_Whistleboard te = (TileBR_UK_Whistleboard) p_149727_1_.getTileEntity(p_149727_2_, p_149727_3_, p_149727_4_);
	...
	@Override
	public TileEntity createTileEntity(World world, int metadata) { return new TileBR_UK_Whistleboard();
	}

	@Override
	public TileEntity createNewTileEntity(World world, int metadata) { return new TileBR_UK_Whistleboard();
	}
