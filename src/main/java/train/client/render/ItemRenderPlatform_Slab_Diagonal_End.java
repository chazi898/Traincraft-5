...
public class ItemRenderPlatform_Slab_Diagonal_End implements IItemRenderer {
    private static final ModelPlatform_Slab_Diagonal_End modelSwitch = new ModelPlatform_Slab_Diagonal_End();
    private static final ResourceLocation texture = new ResourceLocation(Info.resourceLocation,Info.modelTexPrefix + "Platform_Slab_Diagonal_End.png");
    private Object IIconRegister;
    private Object IItemRenderer;
    private IIcon itemIcon;

    public ItemRenderPlatform_Slab_Diagonal_End() {
    }
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        Tessellator.bindTexture(new ResourceLocation(Info.resourceLocation, Info.modelTexPrefix + "Platform_Slab_Diagonal_End.png"));
        switch (type) {
            case ENTITY: {
    ...
    public void registerIcons(IIconRegister iconRegister) {
        this.itemIcon = iconRegister.registerIcon(Info.modID.toLowerCase() + ":platform_slab_diagonal");
    }
