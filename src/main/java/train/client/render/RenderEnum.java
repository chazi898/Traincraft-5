...
public enum RenderEnum implements TrainRenderRecord {
    ...
    MILWPasenger(EntityPassengerMILW.class, new ModelMILWPassenger(), "milw_passenger", false, new float[]{-0.1F, 0F, 0F}, new float[]{0F, 180F, 180F}, new float[]{0.9f, 0.9f, 0.9f}, "", 0, null, "", null, 0, false),
...
//	freight7Plank(EntityFreight7Plank.class, new ModelFreight7Plank(), "7_plank_", true, new float[]{0F,0.2F,0F}, new float[] {0F, 180F, 180F }, null, "",0,null,"",null, 0, false),
    ...
    passengerBNLRV_B(EntityPassengerBNLRV_B.class, new ModelBNLRV_B(), "bnlrv_", true, new float[]{-1.4f, 0.13f, 0.0f}, new float[]{0F, 180F, 180F}, null, "", 0, null, "", null, 0, false),
    locoBNLRV_A(EntityLocoElectricBNLRV_A.class, new ModelBNLRV_A(), "bnlrv_", true, new float[]{-1.3f, 0.13f, 0.0f}, new float[]{0F, 180F, 180F}, null, "", 0, null, "", null, 0, false),
    ...
    locoGWRMogul(EntityLocoSteamGWRMogul.class, new ModelGWRMogul(), "GWR_Mogul_", true, new float[]{-1.25f, 0f, 0}, new float[]{0, 180, 180}, null, "largesmoke", 3, new ArrayList<double[]>() {
        {
            add(new double[]{2.62D, 1.35D, 0D});
        }
    }, "explode", new ArrayList<double[]>() {
        {
    ...
    loco042Jenny(EntityLocoSteam042Jenny.class, new ModelJenny(), "Jenny_", true, new float[]{-2.15f, 0.16f, 0}, new float[]{0, 180, 180}, null, "largesmoke", 3, new ArrayList<double[]>() {
        {
            add(new double[]{2.5D, 1.55D, 0D});
        }
    }, "explode", new ArrayList<double[]>() {
        {
            add(new double[]{2.92D, -0.05D, 0.65D});
    ...
    LocoChurchward3500GalTender(EntityTenderChurchward3500Gal.class, new ModelChurchward3500GalTender(), "Churchward_3500_Gal_", true, new float[]{0.05f, 0f, 0f,}, new float[]{0F, 180f, 180F}, null, "", 0, null, "", null, 0, false),
    LocoLMS_10Ton_Tender(EntityTenderLMS_10Ton.class, new ModelLMS_10Ton_Tender(), "LMS_10Ton_Tender_", true, new float[]{0f, 0f, 0f,}, new float[]{0F, 180f, 180F}, null, "", 0, null, "", null, 0, false),
    Loco042JennyTender(EntityTender042Jenny.class, new ModelJennyTender(), "Jenny_Tender_", true, new float[]{-0.58f, 0.16f, 0f,}, new float[]{0F, 180f, 180F}, null, "", 0, null, "", null, 0, false),
    Tender_RW_Type_2(EntityTenderRWType2.class, new ModelRW_Type_2_Tender(), "Type_2_", true, new float[]{0f, 0.16f, 0f,}, new float[]{0F, 180F, 180F}, null, "", 0, null, "", null, 0, false),
    ...
    passengerMetro2000(EntityPassengerMetro2000.class, new ModelMetro2000Tail(), "metro_2000_", true, new float[]{-1.5F, 0.2F, 0.0F}, new float[]{0F, 180F, 180F}, null, "", 0, null, "", null, 0, false),
    locoElectricRenfe450Motor(EntityLocoElectricRenfe450Motor.class, new Modelrenfe450endA(), "450_loco_", true, new float[]{-1.7F, 0.15F, 0.0F}, new float[]{0F, 0F, 180F}, null, "", 0, null, "", null, 0, false),
    passengerRenfe450Coach(EntityPassengerRenfe450Coach.class, new Modelrenfe450middle(), "450_passenger_", true, new float[]{-0.0F, 0.15F, 0.0F}, new float[]{0F, 180F, 180F}, null, "", 0, null, "", null, 0, false),
    cabooseRenfe450Tail(EntityCabooseRenfe450Tail.class, new Modelrenfe450endB(), "450_passenger_", true, new float[]{-1.55F, 0.15F, 0.0F}, new float[]{0F, 0F, 180F}, null, "", 0, null, "", null, 0, false),
    ...
    //tcce4 new stuff
    SNCB_M6(EntityPassengerSNCB_M6.class, new ModelSNCB_M6(), "SNCB_M6_", true, new float[]{-2.05f, .095F, 0F}, new float[]{0f, 180F, 180F}, null, "", 0, null, "", null, 0, false),
    ...
    BR_MK2F_Coach(EntityPassengerBR_MK2F_Coach.class, new ModelBR_MK2F_Coach(), "BR_Mk2f_", true, new float[]{0.475F, 0F, 0F}, new float[]{0F, 180F, 180F}, null, "", 0, null, "", null, 0, false),
    BR_MK2F_BSO(EntityPassengerBR_MK2F_BSO.class, new ModelBR_MK2F_BSO(), "BR_Mk2f_BSO_", true, new float[]{0.475F, 0F, 0F}, new float[]{0F, 180F, 180F}, null, "", 0, null, "", null, 0, false),
    ...
    BR_MK4_Coach(EntityPassengerBR_MK4_Coach.class, new ModelBR_MK4_Coach(), "BR_Mk4_", true, new float[]{0.17F, 0F, 0F}, new float[]{0F, 180F, 180F}, null, "", 0, null, "", null, 0, false),
    BR_MK4_Buffet(EntityPassengerBR_MK4_Buffet.class, new ModelBR_MK4_Buffet(), "BR_Mk4_Buffet_", true, new float[]{0.17F, 0F, 0F}, new float[]{0F, 180F, 180F}, null, "", 0, null, "", null, 0, false),
    ...
    Class90(EntityElectricClass90.class, new ModelClass90(), "Class_90_", true, new float[]{-0.55F, 0.06F, 0F}, new float[]{0F, 180F, 180F}, null, "", 0, null, "", null, 0, false),
    Class91(EntityElectricClass91.class, new ModelClass91(), "Class_91_", true, new float[]{-1.2F, 0.06F, 0F}, new float[]{0F, 180F, 180F}, null, "", 0, null, "", null, 0, false),
    ...
    Class321Panto(EntityPassengerClass321Panto.class, new ModelClass321_Panto(), "Class_321_Panto_Car_", true, new float[]{0.65F, -0.455F, 0F}, new float[]{0F, 180F, 180F}, null, "", 0, null, "", null, 0, false),
    Class321Coach(EntityPassengerClass321Coach.class, new ModelClass321Coach(), "Class_321_Trailer_Car_", true, new float[]{0.65F, -0.455F, 0F}, new float[]{0F, 180F, 180F}, null, "", 0, null, "", null, 0, false),
    ...
    Class404motor(EntityElectricClass404motor.class, new ModelClass404motor(), "Class_404_", true, new float[]{-2F, 0.155F, 0F}, new float[]{0F, 180F, 180F}, null, "", 0, null, "", null, 0, false),
    Class404second(EntityPassengerClass404second.class, new ModelClass404second(), "Class_404_", true, new float[]{0F, 0.155F, 0F}, new float[]{0F, 180F, 180F}, null, "", 0, null, "", null, 0, false),
    Class404composite(EntityPassengerClass404composite.class, new ModelClass404composite(), "Class_404_", true, new float[]{0F, 0.155F, 0F}, new float[]{0F, 180F, 180F}, null, "", 0, null, "", null, 0, false),
    Class404tail(EntityPassengerClass404tail.class, new ModelClass404motor(), "Class_404_", true, new float[]{0F, 0.155F, 0F}, new float[]{0F, 180F, 180F}, null, "", 0, null, "", null, 0, false),
    ...
    B80C_A(EntityElectricB80C_A.class, new ModelB80C_A(), "B80C_", true, new float[]{-1.17F, 0.2F, 0F}, new float[]{0F, 180F, 180F}, null, "", 0, null, "", null, 0, false),
    B80C_B(EntityPassengerB80C_B.class, new ModelB80C_B(), "B80C_", true, new float[]{-1.17F, 0.2F, 0F}, new float[]{0F, 180F, 180F}, null, "", 0, null, "", null, 0, false),
    ...
    RefrigeratedVan(EntityFreightRefrigeratedVan.class, new ModelRefrigeratedVan(), "Refrigerated_Van_", true, new float[]{0F, 0.1F, 0F}, new float[]{0F, 180F, 180F}, null, "", 0, null, "", null, 0, false),
    ...
    BR_MK2C_Coach(EntityPassengerBR_MK2C_Coach.class, new ModelBR_MK2C_Coach(), "BR_Mk2c_", true, new float[]{0.475F, 0F, 0F}, new float[]{0F, 180F, 180F}, null, "", 0, null, "", null, 0, false),
    BR_MK2C_BSO(EntityPassengerBR_MK2C_BSO.class, new ModelBR_MK2C_BSO(), "BR_Mk2c_BSO_", true, new float[]{0.475F, 0F, 0F}, new float[]{0F, 180F, 180F}, null, "", 0, null, "", null, 0, false),
    ...
    DuewagGT6ERTail(EntityPassengerDuewagGT6ERTail.class, new ModelDuewagGT6ERTail(), "Duewag_GT6ER_", true, new float[]{-1F, 0.2F, 0F}, new float[]{0F, 180F, 180F}, null, "", 0, null, "", null, 0, false),
