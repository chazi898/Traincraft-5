...
public class ItemRenderBR_UK_SpeedSign_CutoutRight implements IItemRenderer {
    ...
    private static final ResourceLocation texture = new ResourceLocation(Info.resourceLocation,Info.modelTexPrefix + "BR_UK_SpeedSign_Cutout_45_Right.png");
    private Object IIconRegister;
    private Object IItemRenderer;
    private IIcon itemIcon;

    public ItemRenderBR_UK_SpeedSign_CutoutRight() {
    }
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        Tessellator.bindTexture(new ResourceLocation(Info.resourceLocation, Info.modelTexPrefix + "BR_UK_SpeedSign_Cutout_45_Right.png"));
        switch (type) {
            case ENTITY: {
