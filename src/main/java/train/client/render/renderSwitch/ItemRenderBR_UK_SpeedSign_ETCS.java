...
public class ItemRenderBR_UK_SpeedSign_ETCS implements IItemRenderer {
    private static final ModelBR_UK_SpeedSign modelSwitch = new ModelBR_UK_SpeedSign();
    private static final ResourceLocation texture = new ResourceLocation(Info.resourceLocation,Info.modelTexPrefix + "BR_UK_SpeedSign_ETCS_100.png");
    private Object IIconRegister;
    private Object IItemRenderer;
    private IIcon itemIcon;

    public ItemRenderBR_UK_SpeedSign_ETCS() {
    }
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        Tessellator.bindTexture(new ResourceLocation(Info.resourceLocation, Info.modelTexPrefix + "BR_UK_SpeedSign_ETCS_100.png"));
        switch (type) {
            case ENTITY: {
