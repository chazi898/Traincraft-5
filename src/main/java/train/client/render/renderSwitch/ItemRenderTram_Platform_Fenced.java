...
public class ItemRenderTram_Platform_Fenced implements IItemRenderer {
    private static final ModelTramPlatformFenced modelSwitch = new ModelTramPlatformFenced();
    private static final ResourceLocation texture = new ResourceLocation(Info.resourceLocation,Info.modelTexPrefix + "Tram_Platform_Blue.png");
    private Object IIconRegister;
    private Object IItemRenderer;
    private IIcon itemIcon;

    public ItemRenderTram_Platform_Fenced() {
    }
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        Tessellator.bindTexture(new ResourceLocation(Info.resourceLocation, Info.modelTexPrefix + "Tram_Platform_Blue.png"));
        switch (type) {
            case ENTITY: {
    ...
    public void registerIcons(IIconRegister iconRegister) {
        this.itemIcon = iconRegister.registerIcon(Info.modID.toLowerCase() + ":tram_platform_fenced.png");
    }
