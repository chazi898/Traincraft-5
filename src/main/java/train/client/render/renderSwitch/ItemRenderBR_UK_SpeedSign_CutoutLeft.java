...
public class ItemRenderBR_UK_SpeedSign_CutoutLeft implements IItemRenderer {
    private static final ModelBR_UK_SpeedSign_Cutout modelSwitch = new ModelBR_UK_SpeedSign_Cutout();
    private static final ResourceLocation texture = new ResourceLocation(Info.resourceLocation,Info.modelTexPrefix + "BR_UK_SpeedSign_Cutout_25_Left.png");
    private Object IIconRegister;
    private Object IItemRenderer;
    private IIcon itemIcon;

    public ItemRenderBR_UK_SpeedSign_CutoutLeft() {
    }
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        Tessellator.bindTexture(new ResourceLocation(Info.resourceLocation, Info.modelTexPrefix + "BR_UK_SpeedSign_Cutout_25_Left.png"));
        switch (type) {
            case ENTITY: {
