...
public class ItemRenderBR_UK_SpeedSign_DoubleLeft implements IItemRenderer {
    private static final ModelBR_UK_SpeedSign_Double modelSwitch = new ModelBR_UK_SpeedSign_Double();
    private static final ResourceLocation texture = new ResourceLocation(Info.resourceLocation,Info.modelTexPrefix + "BR_UK_SpeedSign_DoubleLeft_60120.png");
    private Object IIconRegister;
    private Object IItemRenderer;
    private IIcon itemIcon;

    public ItemRenderBR_UK_SpeedSign_DoubleLeft() {
    }
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        Tessellator.bindTexture(new ResourceLocation(Info.resourceLocation, Info.modelTexPrefix + "BR_UK_SpeedSign_DoubleLeft_60120.png"));
        switch (type) {
            case ENTITY: {
