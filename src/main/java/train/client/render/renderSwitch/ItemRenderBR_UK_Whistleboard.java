...
public class ItemRenderBR_UK_Whistleboard implements IItemRenderer {
    private static final ModelBR_UK_Whistleboard modelSwitch = new ModelBR_UK_Whistleboard();
    private static final ResourceLocation texture = new ResourceLocation(Info.resourceLocation,Info.modelTexPrefix + "BR_UK_Whistleboard_W.png");
    private Object IIconRegister;
    private Object IItemRenderer;
    private IIcon itemIcon;

    public ItemRenderBR_UK_Whistleboard() {
    }
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        Tessellator.bindTexture(new ResourceLocation(Info.resourceLocation, Info.modelTexPrefix + "BR_UK_Whistleboard_W.png"));
        switch (type) {
            case ENTITY: {
    ...
    public void registerIcons(IIconRegister iconRegister) {
        this.itemIcon = iconRegister.registerIcon(Info.modID.toLowerCase() + ":br_uk_whistleboard");
    }
