...
public class ItemRenderBR_4_Aspect_Signal implements IItemRenderer {
    ...
    private static final ResourceLocation texture = new ResourceLocation(Info.resourceLocation,Info.modelTexPrefix + "BR_4_Aspect_Signal_Green.png");
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        Tessellator.bindTexture(new ResourceLocation(Info.resourceLocation, Info.modelTexPrefix + "BR_4_Aspect_Signal_Green.png"));
        switch (type) {
            case ENTITY: {
    ...
    public void registerIcons(IIconRegister iconRegister) {
        this.itemIcon = iconRegister.registerIcon(Info.modID.toLowerCase() + ":br_4_aspect_signal");
    }
