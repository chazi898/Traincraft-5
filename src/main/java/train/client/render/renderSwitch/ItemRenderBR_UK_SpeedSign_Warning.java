...
public class ItemRenderBR_UK_SpeedSign_Warning implements IItemRenderer {
    private static final ModelBR_UK_SpeedSign_Warning modelSwitch = new ModelBR_UK_SpeedSign_Warning();
    private static final ResourceLocation texture = new ResourceLocation(Info.resourceLocation,Info.modelTexPrefix + "BR_UK_SpeedSign_Warning_50.png");
    private Object IIconRegister;
    private Object IItemRenderer;
    private IIcon itemIcon;

    public ItemRenderBR_UK_SpeedSign_Warning() {
    }
