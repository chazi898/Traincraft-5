...
public class RenderBR_3_Aspect_Signal extends TileEntitySpecialRenderer {
	...
	private ResourceLocation[] textures = {new ResourceLocation(Info.resourceLocation, Info.modelTexPrefix + "BR_3_Aspect_Signal_Red.png"), new ResourceLocation(Info.resourceLocation, Info.modelTexPrefix + "BR_3_Aspect_Signal_Yellow.png"), new ResourceLocation(Info.resourceLocation, Info.modelTexPrefix + "BR_3_Aspect_Signal_Green.png")};
