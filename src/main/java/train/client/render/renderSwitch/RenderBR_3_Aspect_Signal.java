...
public class RenderBR_3_Aspect_Signal extends TileEntitySpecialRenderer {
	...
	private ResourceLocation[] textures = {
			new ResourceLocation(Info.resourceLocation, Info.modelTexPrefix + "BR_3_Aspect_Signal_Off.png"),
			new ResourceLocation(Info.resourceLocation, Info.modelTexPrefix + "BR_3_Aspect_Signal_Off.png"),
			new ResourceLocation(Info.resourceLocation, Info.modelTexPrefix + "BR_3_Aspect_Signal_Green.png"),
			new ResourceLocation(Info.resourceLocation, Info.modelTexPrefix + "BR_3_Aspect_Signal_Off.png"),
			new ResourceLocation(Info.resourceLocation, Info.modelTexPrefix + "BR_3_Aspect_Signal_Yellow.png"),
			new ResourceLocation(Info.resourceLocation, Info.modelTexPrefix + "BR_3_Aspect_Signal_Red.png")};

	@Override
	public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
		if (((TileBR_3_Aspect_Signal) tileEntity).getConnectingMode() && ((TileBR_3_Aspect_Signal) tileEntity).getAllowFlashing()) {
			Tessellator.bindTexture(textures[((TileBR_3_Aspect_Signal) tileEntity).getIsActive() ? 3 : 0]);
		}
		else {
			Tessellator.bindTexture(textures[((TileBR_3_Aspect_Signal) tileEntity).getAspect().ordinal()]);
		}
		GL11.glPushMatrix();
		...
		switch (((TileBR_3_Aspect_Signal) tileEntity).getDiagonalfacing()) {
			case 0: {
