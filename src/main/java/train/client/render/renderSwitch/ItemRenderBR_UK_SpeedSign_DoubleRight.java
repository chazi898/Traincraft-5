...
public class ItemRenderBR_UK_SpeedSign_DoubleRight implements IItemRenderer {
    private static final ModelBR_UK_SpeedSign_Double modelSwitch = new ModelBR_UK_SpeedSign_Double();
    private static final ResourceLocation texture = new ResourceLocation(Info.resourceLocation,Info.modelTexPrefix + "BR_UK_SpeedSign_DoubleRight_5090.png");
    private Object IIconRegister;
    private Object IItemRenderer;
    private IIcon itemIcon;

    public ItemRenderBR_UK_SpeedSign_DoubleRight() {
    }
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        Tessellator.bindTexture(new ResourceLocation(Info.resourceLocation, Info.modelTexPrefix + "BR_UK_SpeedSign_DoubleRight_5090.png"));
        switch (type) {
            case ENTITY: {
