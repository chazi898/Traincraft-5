...
import train.client.render.models.blocks.ModelPlatform_Slab_Diagonal_Right;
...
public class ItemRenderPlatform_Slab_Diagonal_Right implements IItemRenderer {
    ...
    private static final ResourceLocation texture = new ResourceLocation(Info.resourceLocation,Info.modelTexPrefix + "Platform_Slab_Diagonal_Right.png");
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        Tessellator.bindTexture(new ResourceLocation(Info.resourceLocation, Info.modelTexPrefix + "Platform_Slab_Diagonal_Right.png"));
        switch (type) {
            case ENTITY: {
