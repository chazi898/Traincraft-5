...
import train.client.render.models.blocks.ModelPlatform_Slab_End_Left;
import train.common.library.Info;

public class ItemRenderPlatform_Slab_End_Left implements IItemRenderer {
    private static final ModelPlatform_Slab_End_Left modelSwitch = new ModelPlatform_Slab_End_Left();
    private static final ResourceLocation texture = new ResourceLocation(Info.resourceLocation,Info.modelTexPrefix + "Platform_Slab_End.png");
    private Object IIconRegister;
    private Object IItemRenderer;
    private IIcon itemIcon;

    public ItemRenderPlatform_Slab_End_Left() {
    }
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        Tessellator.bindTexture(new ResourceLocation(Info.resourceLocation, Info.modelTexPrefix + "Platform_Slab_End.png"));
        switch (type) {
            case ENTITY: {
            ...
            case INVENTORY: {
                ...
                GL11.glRotatef(80,0f,1f,0f);
                renderSwitch(0.4f, 0f, -0.2f, 0.7f);
                GL11.glPopMatrix();
