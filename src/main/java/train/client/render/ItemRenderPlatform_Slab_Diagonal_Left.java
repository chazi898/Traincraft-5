...
public class ItemRenderPlatform_Slab_Diagonal_Left implements IItemRenderer {
    private static final ModelPlatform_Slab_Diagonal_Left modelSwitch = new ModelPlatform_Slab_Diagonal_Left();
    ...
    public ItemRenderPlatform_Slab_Diagonal_Left() {
    }
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        Tessellator.bindTexture(new ResourceLocation(Info.resourceLocation, Info.modelTexPrefix + "Platform_Slab_Diagonal_Left.png"));
        switch (type) {
            case ENTITY: {
