...
import train.client.render.models.blocks.ModelPlatform_Slab_End_Right;
import train.common.library.Info;

public class ItemRenderPlatform_Slab_End_Right implements IItemRenderer {
    private static final ModelPlatform_Slab_End_Right modelSwitch = new ModelPlatform_Slab_End_Right();
    ...
    public ItemRenderPlatform_Slab_End_Right() {
    }
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        switch (type) {
            ...
            case INVENTORY: {
                ...
                renderSwitch(0.2f, 0.1f, -0.2f, 0.7f);
                GL11.glPopMatrix();
