...
public class ModelHornby060E2 extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 512;

	public ModelHornby060E2() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[254] = new ModelRendererTurbo(this, 273, 73, textureX, textureY); // Box 5
		bodyModel[255] = new ModelRendererTurbo(this, 433, 65, textureX, textureY); // Box 5
		bodyModel[256] = new ModelRendererTurbo(this, 297, 73, textureX, textureY); // Box 74
		bodyModel[257] = new ModelRendererTurbo(this, 105, 137, textureX, textureY); // Box 75
		bodyModel[258] = new ModelRendererTurbo(this, 345, 73, textureX, textureY); // Box 75
		bodyModel[259] = new ModelRendererTurbo(this, 89, 137, textureX, textureY); // Box 75
		bodyModel[260] = new ModelRendererTurbo(this, 337, 185, textureX, textureY); // Box 20
		bodyModel[261] = new ModelRendererTurbo(this, 313, 157, textureX, textureY); // Box 23
		bodyModel[262] = new ModelRendererTurbo(this, 113, 183, textureX, textureY); // Box 25
		bodyModel[263] = new ModelRendererTurbo(this, 33, 209, textureX, textureY); // Box 26
		bodyModel[264] = new ModelRendererTurbo(this, 161, 197, textureX, textureY); // Box 27
		bodyModel[265] = new ModelRendererTurbo(this, 1, 198, textureX, textureY); // Box 28
		bodyModel[266] = new ModelRendererTurbo(this, 123, 210, textureX, textureY); // Box 182
		bodyModel[267] = new ModelRendererTurbo(this, 151, 210, textureX, textureY); // Box 182
		bodyModel[268] = new ModelRendererTurbo(this, 142, 210, textureX, textureY); // Box 182
		bodyModel[269] = new ModelRendererTurbo(this, 133, 210, textureX, textureY); // Box 182
		bodyModel[270] = new ModelRendererTurbo(this, 160, 210, textureX, textureY); // Box 182
		bodyModel[271] = new ModelRendererTurbo(this, 123, 220, textureX, textureY); // Box 182
		bodyModel[272] = new ModelRendererTurbo(this, 151, 220, textureX, textureY); // Box 182
		bodyModel[273] = new ModelRendererTurbo(this, 142, 220, textureX, textureY); // Box 182
		bodyModel[274] = new ModelRendererTurbo(this, 133, 220, textureX, textureY); // Box 182
		bodyModel[275] = new ModelRendererTurbo(this, 160, 220, textureX, textureY); // Box 182
		bodyModel[276] = new ModelRendererTurbo(this, 433, 217, textureX, textureY); // Box 109
		bodyModel[277] = new ModelRendererTurbo(this, 441, 217, textureX, textureY); // Box 109
		bodyModel[278] = new ModelRendererTurbo(this, 449, 217, textureX, textureY); // Box 109
		bodyModel[279] = new ModelRendererTurbo(this, 473, 217, textureX, textureY); // Box 109
		bodyModel[280] = new ModelRendererTurbo(this, 489, 217, textureX, textureY); // Box 109
		bodyModel[281] = new ModelRendererTurbo(this, 497, 217, textureX, textureY); // Box 109
		bodyModel[282] = new ModelRendererTurbo(this, 505, 217, textureX, textureY); // Box 109
		bodyModel[283] = new ModelRendererTurbo(this, 1, 225, textureX, textureY); // Box 109
		bodyModel[284] = new ModelRendererTurbo(this, 505, 217, textureX, textureY); // Box 109
		bodyModel[285] = new ModelRendererTurbo(this, 1, 225, textureX, textureY); // Box 109
		bodyModel[286] = new ModelRendererTurbo(this, 73, 211, textureX, textureY); // Box 51
		bodyModel[287] = new ModelRendererTurbo(this, 300, 196, textureX, textureY); // Box 52

		bodyModel[0].addBox(0F, 0F, 0F, 1, 5, 22, 0F); // Box 0
		bodyModel[0].setRotationPoint(0F, 0.5F, -11.2F);

		bodyModel[1].addBox(0F, 0F, 0F, 56, 5, 12, 0F); // Box 1
		bodyModel[1].setRotationPoint(-56F, 0.5F, -6.2F);

		bodyModel[2].addBox(0F, 0F, 0F, 1, 5, 22, 0F); // Box 2
		bodyModel[2].setRotationPoint(-57F, 0.5F, -11.2F);

		bodyModel[3].addBox(0F, 0F, 0F, 4, 1, 5, 0F); // Box 3
		bodyModel[3].setRotationPoint(-56F, 0.5F, -11.2F);

		bodyModel[4].addBox(0F, 0F, 0F, 6, 1, 22, 0F); // Box 6
		bodyModel[4].setRotationPoint(-5F, -0.5F, -11.2F);

		bodyModel[5].addBox(0F, 0F, 0F, 4, 1, 5, 0F); // Box 7
		bodyModel[5].setRotationPoint(-56F, 0.5F, 5.8F);

		bodyModel[6].addShapeBox(0F, 0F, 0F, 4, 1, 5, 0F,0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 1F, 0F); // Box 10
		bodyModel[6].setRotationPoint(-52F, -0.5F, -11.2F);

		bodyModel[7].addShapeBox(0F, 0F, 0F, 4, 1, 5, 0F,0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 1F, 0F); // Box 11
		bodyModel[7].setRotationPoint(-52F, -0.5F, 5.8F);

		bodyModel[8].addBox(0F, 0F, 0F, 43, 1, 5, 0F); // Box 12
		bodyModel[8].setRotationPoint(-48F, -0.5F, 5.8F);

		bodyModel[9].addBox(0F, 0F, 0F, 43, 1, 5, 0F); // Box 13
		bodyModel[9].setRotationPoint(-48F, -0.5F, -11.2F);
		...
		bodyModel[10].setRotationPoint(-48F, -3.5F, -11.2F);
		...
		bodyModel[11].setRotationPoint(-41F, -3.5F, -11.2F);

		bodyModel[12].addBox(0F, 0F, 0F, 3, 3, 5, 0F); // Box 16
		bodyModel[12].setRotationPoint(-44F, -3.5F, -11.2F);

		bodyModel[13].addBox(0F, 0F, 0F, 3, 3, 5, 0F); // Box 17
		bodyModel[13].setRotationPoint(-44F, -3.5F, 5.8F);
		...
		bodyModel[14].setRotationPoint(-48F, -3.5F, 5.8F);
		...
		bodyModel[15].setRotationPoint(-41F, -3.5F, 5.8F);
		...
		bodyModel[16].setRotationPoint(-41F, -10.5F, 9.8F);
		...
		bodyModel[17].setRotationPoint(-34F, -3.5F, 9.8F);
		...
		bodyModel[18].setRotationPoint(-34F, -3.5F, -11.2F);
		...
		bodyModel[19].setRotationPoint(-41F, -10.5F, -11.2F);
		...
		bodyModel[20].setRotationPoint(-41F, -11.5F, -11.2F);

		bodyModel[21].addBox(0F, 0F, 0F, 1, 7, 3, 0F); // Box 26
		bodyModel[21].setRotationPoint(-41F, -10.5F, -10.2F);

		bodyModel[22].addBox(0F, 0F, 0F, 1, 7, 3, 0F); // Box 27
		bodyModel[22].setRotationPoint(-41F, -10.5F, 6.8F);
		...
		bodyModel[23].setRotationPoint(-41F, -11.5F, 6.8F);

		bodyModel[24].addBox(0F, 0F, 0F, 1, 5, 4, 0F); // Box 29
		bodyModel[24].setRotationPoint(-34F, -5.5F, 5.8F);

		bodyModel[25].addBox(0F, 0F, 0F, 1, 3, 4, 0F); // Box 30
		bodyModel[25].setRotationPoint(-34F, -3.5F, -10.2F);

		bodyModel[26].addBox(0F, 0F, 0F, 7, 7, 1, 0F); // Box 31
		bodyModel[26].setRotationPoint(-41F, -7.5F, 5.8F);

		bodyModel[27].addBox(0F, 0F, 0F, 7, 1, 4, 0F); // Box 32
		bodyModel[27].setRotationPoint(-40F, -4.5F, -10.2F);

		bodyModel[28].addBox(0F, 0F, 0F, 35, 4, 1, 0F); // Box 30
		bodyModel[28].setRotationPoint(-51F, -11.5F, -7.2F);
		...
		bodyModel[29].setRotationPoint(-51F, -14.5F, -6.2F);
		...
		bodyModel[30].setRotationPoint(-51F, -16.5F, -3.2F);
		...
		bodyModel[31].setRotationPoint(-51F, -16.5F, 1.8F);

		bodyModel[32].addBox(0F, 0F, 0F, 35, 4, 1, 0F); // Box 34
		bodyModel[32].setRotationPoint(-51F, -11.5F, 5.8F);
		...
		bodyModel[33].setRotationPoint(-51F, -14.5F, 4.8F);
		...
		bodyModel[34].setRotationPoint(-51F, -17.5F, -3.2F);
		...
		bodyModel[35].setRotationPoint(-51F, -7.5F, -7.2F);
		...
		bodyModel[36].setRotationPoint(-51F, -4.5F, -6.2F);
		...
		bodyModel[37].setRotationPoint(-51F, -4.5F, 4.8F);
		...
		bodyModel[38].setRotationPoint(-51F, -7.5F, 5.8F);
		...
		bodyModel[39].setRotationPoint(-51F, -2.5F, -3.2F);
		...
		bodyModel[40].setRotationPoint(-16F, -11.5F, -11.2F);

		bodyModel[41].addBox(0F, 0F, 0F, 10, 1, 12, 0F); // Box 43
		bodyModel[41].setRotationPoint(-15F, -0.5F, -6.2F);

		bodyModel[42].addBox(0F, 0F, 0F, 1, 5, 22, 0F); // Box 44
		bodyModel[42].setRotationPoint(-16F, -16.5F, -11.2F);
		...
		bodyModel[43].setRotationPoint(-15F, -12.5F, -11.2F);
		...
		bodyModel[44].setRotationPoint(-7F, -12.5F, -11.2F);

		bodyModel[45].addBox(0F, 0F, 0F, 1, 18, 20, 0F); // Box 49
		bodyModel[45].setRotationPoint(0F, -18.5F, -10.2F);

		bodyModel[46].addBox(0F, 0F, 0F, 9, 4, 1, 0F); // Box 51
		bodyModel[46].setRotationPoint(-48F, -4.5F, -6.2F);

		bodyModel[47].addBox(0F, 0F, 0F, 10, 5, 1, 0F); // Box 52
		bodyModel[47].setRotationPoint(-48F, -4.5F, 4.8F);
		...
		bodyModel[48].setRotationPoint(-48F, -3.5F, -5.2F);

		bodyModel[49].addBox(0F, 0F, 0F, 1, 2, 6, 0F); // Box 56
		bodyModel[49].setRotationPoint(-48F, -1.5F, -3.2F);

		bodyModel[50].addBox(0F, 0F, 0F, 35, 4, 12, 0F); // Box 57
		bodyModel[50].setRotationPoint(-51.4F, -11.5F, -6.2F);

		bodyModel[51].addBox(0F, 0F, 0F, 1, 4, 2, 0F); // Box 58
		bodyModel[51].setRotationPoint(-16F, -20.5F, -11.2F);

		bodyModel[52].addBox(0F, 0F, 0F, 8, 1, 1, 0F); // Box 65
		bodyModel[52].setRotationPoint(-56F, -0.5F, 4.8F);

		bodyModel[53].addBox(0F, 0F, 0F, 8, 1, 1, 0F); // Box 66
		bodyModel[53].setRotationPoint(-56F, -0.5F, -6.2F);
		...
		bodyModel[54].setRotationPoint(-57F, -0.5F, -6.2F);
		...
		bodyModel[55].setRotationPoint(-57F, -0.5F, 4.8F);

		bodyModel[56].addBox(0F, 0F, 0F, 10, 10, 0, 0F); // Box 5
		bodyModel[56].setRotationPoint(-49F, 0F, 6F);

		bodyModel[57].addBox(0F, 0F, 0F, 10, 10, 0, 0F); // Box 5
		bodyModel[57].setRotationPoint(-31F, 0F, 6F);

		bodyModel[58].addBox(0F, 0F, 0F, 10, 10, 0, 0F); // Box 5
		bodyModel[58].setRotationPoint(-49F, 0F, -6.3F);

		bodyModel[59].addBox(0F, 0F, 0F, 10, 10, 0, 0F); // Box 5
		bodyModel[59].setRotationPoint(-31F, 0F, -6.3F);
		...
		bodyModel[60].setRotationPoint(-48F, -3.5F, 2.8F);
		...
		bodyModel[61].setRotationPoint(-43.5F, 6F, 5.8F);

		bodyModel[62].addBox(0F, 0F, 0F, 21, 1, 1, 0F); // Box 75
		bodyModel[62].setRotationPoint(-45.5F, 3F, -7F);
		...
		bodyModel[63].setRotationPoint(0F, -18.5F, 9.8F);
		...
		bodyModel[64].setRotationPoint(-4F, -18.5F, -11.2F);

		bodyModel[65].addBox(0F, 0F, 0F, 1, 16, 20, 0F); // Box 78
		bodyModel[65].setRotationPoint(-5F, -16.5F, -10.2F);

		bodyModel[66].addBox(0F, 0F, 0F, 4, 4, 20, 0F); // Box 79
		bodyModel[66].setRotationPoint(-4F, -12.5F, -10.2F);
		...
		bodyModel[67].setRotationPoint(-48F, -2.5F, 0.8F);
		...
		bodyModel[68].setRotationPoint(-48F, -2.5F, -3.2F);

		bodyModel[69].addBox(0F, 0F, 0F, 4, 1, 1, 0F); // Box 100
		bodyModel[69].setRotationPoint(-11.5F, 1.5F, 10F);
		...
		bodyModel[70].setRotationPoint(-51.4F, -14.5F, -5.2F);
		...
		bodyModel[71].setRotationPoint(-51.4F, -7.5F, -5.2F);
		...
		bodyModel[72].setRotationPoint(-51.4F, -4.5F, -5.2F);
		...
		bodyModel[73].setRotationPoint(-51.4F, -16.5F, -5.2F);
		...
		bodyModel[74].setRotationPoint(-55F, -2.5F, -9.5F);
		...
		bodyModel[75].setRotationPoint(-55F, -2.5F, -0.5F);
		...
		bodyModel[76].setRotationPoint(-55F, -2.5F, 7.5F);
		...
		bodyModel[77].setRotationPoint(-33F, -20.5F, -0.2F);
		...
		bodyModel[78].setRotationPoint(-33F, -22.5F, -0.2F);

		bodyModel[79].addBox(0F, 0F, 0F, 11, 1, 1, 0F); // Box 133
		bodyModel[79].setRotationPoint(-15F, -20.5F, -11.2F);

		bodyModel[80].addBox(0F, 0F, 0F, 11, 1, 1, 0F); // Box 134
		bodyModel[80].setRotationPoint(-15F, -20.5F, 9.8F);

		bodyModel[81].addBox(0F, 0F, 0F, 2, 3, 1, 0F); // Box 0
		bodyModel[81].setRotationPoint(-59F, 2F, -7.5F);

		bodyModel[82].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 0
		bodyModel[82].setRotationPoint(-59F, 3F, -8.5F);
		...
		bodyModel[83].setRotationPoint(-59F, 2F, -8.5F);
		...
		bodyModel[84].setRotationPoint(-59F, 2F, -6.5F);
		...
		bodyModel[85].setRotationPoint(-59F, 4F, -8.5F);
		...
		bodyModel[86].setRotationPoint(-59F, 4F, -6.5F);

		bodyModel[87].addBox(0F, 0F, 0F, 1, 6, 2, 0F); // Box 0
		bodyModel[87].setRotationPoint(-60F, 0.5F, -8F);

		bodyModel[88].addBox(0F, 0F, 0F, 1, 2, 2, 0F); // Box 0
		bodyModel[88].setRotationPoint(-60F, 2.5F, -10F);

		bodyModel[89].addBox(0F, 0F, 0F, 1, 2, 2, 0F); // Box 0
		bodyModel[89].setRotationPoint(-60F, 2.5F, -6F);
		...
		bodyModel[90].setRotationPoint(-60F, 0.5F, -10F);
		...
		bodyModel[91].setRotationPoint(-60F, 4.5F, -10F);
		...
		bodyModel[92].setRotationPoint(-60F, 0.5F, -6F);
		...
		bodyModel[93].setRotationPoint(-60F, 4.5F, -6F);

		bodyModel[94].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 148
		bodyModel[94].setRotationPoint(-59F, 3F, -6.5F);
		...
		bodyModel[95].setRotationPoint(-59F, 2F, 7.5F);

		bodyModel[96].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 150
		bodyModel[96].setRotationPoint(-59F, 3F, 7.5F);
		...
		bodyModel[97].setRotationPoint(-59F, 4F, 7.5F);

		bodyModel[98].addBox(0F, 0F, 0F, 2, 3, 1, 0F); // Box 152
		bodyModel[98].setRotationPoint(-59F, 2F, 6.5F);
		...
		bodyModel[99].setRotationPoint(-59F, 4F, 5.5F);

		bodyModel[100].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 154
		bodyModel[100].setRotationPoint(-59F, 3F, 5.5F);
		...
		bodyModel[101].setRotationPoint(-59F, 2F, 5.5F);
		...
		bodyModel[102].setRotationPoint(-60F, 0.5F, 4F);

		bodyModel[103].addBox(0F, 0F, 0F, 1, 6, 2, 0F); // Box 157
		bodyModel[103].setRotationPoint(-60F, 0.5F, 6F);

		bodyModel[104].addBox(0F, 0F, 0F, 1, 2, 2, 0F); // Box 158
		bodyModel[104].setRotationPoint(-60F, 2.5F, 4F);
		...
		bodyModel[105].setRotationPoint(-60F, 4.5F, 4F);
		...
		bodyModel[106].setRotationPoint(-60F, 4.5F, 8F);

		bodyModel[107].addBox(0F, 0F, 0F, 1, 2, 2, 0F); // Box 161
		bodyModel[107].setRotationPoint(-60F, 2.5F, 8F);
		...
		bodyModel[108].setRotationPoint(-60F, 0.5F, 8F);
		...
		bodyModel[109].setRotationPoint(1F, 2F, 7.5F);

		bodyModel[110].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 150
		bodyModel[110].setRotationPoint(1F, 3F, 7.5F);
		...
		bodyModel[111].setRotationPoint(1F, 4F, 7.5F);

		bodyModel[112].addBox(0F, 0F, 0F, 2, 3, 1, 0F); // Box 152
		bodyModel[112].setRotationPoint(1F, 2F, 6.5F);
		...
		bodyModel[113].setRotationPoint(1F, 4F, 5.5F);

		bodyModel[114].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 154
		bodyModel[114].setRotationPoint(1F, 3F, 5.5F);
		...
		bodyModel[115].setRotationPoint(1F, 2F, 5.5F);
		...
		bodyModel[116].setRotationPoint(3F, 0.5F, 4F);

		bodyModel[117].addBox(0F, 0F, 0F, 1, 6, 2, 0F); // Box 157
		bodyModel[117].setRotationPoint(3F, 0.5F, 6F);

		bodyModel[118].addBox(0F, 0F, 0F, 1, 2, 2, 0F); // Box 158
		bodyModel[118].setRotationPoint(3F, 2.5F, 4F);
		...
		bodyModel[119].setRotationPoint(3F, 4.5F, 4F);
		...
		bodyModel[120].setRotationPoint(3F, 4.5F, 8F);

		bodyModel[121].addBox(0F, 0F, 0F, 1, 2, 2, 0F); // Box 161
		bodyModel[121].setRotationPoint(3F, 2.5F, 8F);
		...
		bodyModel[122].setRotationPoint(3F, 0.5F, 8F);

		bodyModel[123].addBox(0F, 0F, 0F, 2, 3, 1, 0F); // Box 0
		bodyModel[123].setRotationPoint(1F, 2F, -7.5F);

		bodyModel[124].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 0
		bodyModel[124].setRotationPoint(1F, 3F, -8.5F);
		...
		bodyModel[125].setRotationPoint(1F, 2F, -8.5F);
		...
		bodyModel[126].setRotationPoint(1F, 2F, -6.5F);
		...
		bodyModel[127].setRotationPoint(1F, 4F, -8.5F);
		...
		bodyModel[128].setRotationPoint(1F, 4F, -6.5F);

		bodyModel[129].addBox(0F, 0F, 0F, 1, 6, 2, 0F); // Box 0
		bodyModel[129].setRotationPoint(3F, 0.5F, -8F);

		bodyModel[130].addBox(0F, 0F, 0F, 1, 2, 2, 0F); // Box 0
		bodyModel[130].setRotationPoint(3F, 2.5F, -10F);

		bodyModel[131].addBox(0F, 0F, 0F, 1, 2, 2, 0F); // Box 0
		bodyModel[131].setRotationPoint(3F, 2.5F, -6F);
		...
		bodyModel[132].setRotationPoint(3F, 0.5F, -10F);
		...
		bodyModel[133].setRotationPoint(3F, 4.5F, -10F);
		...
		bodyModel[134].setRotationPoint(3F, 0.5F, -6F);
		...
		bodyModel[135].setRotationPoint(3F, 4.5F, -6F);

		bodyModel[136].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 148
		bodyModel[136].setRotationPoint(1F, 3F, -6.5F);
		...
		bodyModel[137].setRotationPoint(-52F, -11.5F, -7.2F);
		...
		bodyModel[138].setRotationPoint(-52F, -8.5F, -7.2F);
		...
		bodyModel[139].setRotationPoint(-12F, -12.5F, -3.5F);
		...
		bodyModel[140].setRotationPoint(-15.25F, -9.5F, 2.5F);

		bodyModel[141].addBox(0F, 0F, 0F, 1, 3, 1, 0F); // Box 383
		bodyModel[141].setRotationPoint(-15F, -11.75F, 1F);

		bodyModel[142].addBox(0F, 0F, 0F, 1, 3, 1, 0F); // Box 383
		bodyModel[142].setRotationPoint(-15F, -11.75F, -2F);
		...
		bodyModel[143].setRotationPoint(-15F, -14F, -1F);
		...
		bodyModel[144].setRotationPoint(-15F, -14F, -2F);
		...
		bodyModel[145].setRotationPoint(-15F, -13F, -1F);
		...
		bodyModel[146].setRotationPoint(-15F, -13F, -2F);
		...
		bodyModel[147].setRotationPoint(-15F, -14F, 1.25F);
		...
		bodyModel[148].setRotationPoint(-15F, -14F, 2.25F);
		...
		bodyModel[149].setRotationPoint(-15F, -13F, 1.25F);
		...
		bodyModel[150].setRotationPoint(-15F, -13F, 2.25F);
		...
		bodyModel[151].setRotationPoint(-16F, -22.5F, -11.2F);
		...
		bodyModel[152].setRotationPoint(-5F, -22.5F, -11.2F);
		...
		bodyModel[153].setRotationPoint(-16F, -24.5F, -9.2F);
		...
		bodyModel[154].setRotationPoint(-15F, -22.5F, -11.2F);
		...
		bodyModel[155].setRotationPoint(-15F, -22.5F, 9.8F);

		bodyModel[156].addBox(0F, 0F, 0F, 1, 3, 1, 0F); // Box 124
		bodyModel[156].setRotationPoint(-18F, -20F, -1.7F);

		bodyModel[157].addBox(0F, 0F, 0F, 1, 3, 1, 0F); // Box 169
		bodyModel[157].setRotationPoint(-18F, -20F, 0.3F);

		bodyModel[158].addBox(0F, 0F, 0F, 7, 7, 1, 0F); // Box 169
		bodyModel[158].setRotationPoint(-41F, -7.5F, -7.2F);

		bodyModel[159].addBox(0F, 0F, 0F, 1, 7, 1, 0F); // Box 171
		bodyModel[159].setRotationPoint(-15F, -19.5F, 9.8F);

		bodyModel[160].addBox(0F, 0F, 0F, 1, 7, 1, 0F); // Box 172
		bodyModel[160].setRotationPoint(-12F, -19.5F, 9.8F);

		bodyModel[161].addBox(0F, 0F, 0F, 2, 7, 1, 0F); // Box 173
		bodyModel[161].setRotationPoint(-6F, -19.5F, 9.8F);

		bodyModel[162].addBox(0F, 0F, 0F, 2, 7, 1, 0F); // Box 174
		bodyModel[162].setRotationPoint(-6F, -19.5F, -11.2F);

		bodyModel[163].addBox(0F, 0F, 0F, 1, 7, 1, 0F); // Box 175
		bodyModel[163].setRotationPoint(-12F, -19.5F, -11.2F);
		...
		bodyModel[164].setRotationPoint(-40F, -12.5F, -10F);

		bodyModel[165].addBox(0F, 0F, 0F, 1, 4, 10, 0F); // Box 184
		bodyModel[165].setRotationPoint(-16F, -20.5F, -5.2F);

		bodyModel[166].addBox(0F, 0F, 0F, 1, 4, 2, 0F); // Box 185
		bodyModel[166].setRotationPoint(-16F, -20.5F, 8.8F);
		...
		bodyModel[167].setRotationPoint(-16F, -20.5F, -6.2F);
		...
		bodyModel[168].setRotationPoint(-16F, -20.5F, -9.2F);
		...
		bodyModel[169].setRotationPoint(-16F, -17.5F, -6.2F);
		...
		bodyModel[170].setRotationPoint(-16F, -17.5F, 7.8F);
		...
		bodyModel[171].setRotationPoint(-16F, -20.5F, 7.8F);
		...
		bodyModel[172].setRotationPoint(-16F, -20.5F, 4.8F);
		...
		bodyModel[173].setRotationPoint(-16F, -17.5F, 4.8F);
		...
		bodyModel[174].setRotationPoint(-16F, -17.5F, -9.2F);

		bodyModel[175].addBox(0F, 0F, 0F, 1, 4, 1, 0F); // Box 194
		bodyModel[175].setRotationPoint(-5F, -20.5F, -10.2F);
		...
		bodyModel[176].setRotationPoint(-5F, -17.5F, -9.2F);
		...
		bodyModel[177].setRotationPoint(-5F, -17.5F, -6.2F);

		bodyModel[178].addBox(0F, 0F, 0F, 1, 4, 10, 0F); // Box 197
		bodyModel[178].setRotationPoint(-5F, -20.5F, -5.2F);
		...
		bodyModel[179].setRotationPoint(-5F, -20.5F, -6.2F);
		...
		bodyModel[180].setRotationPoint(-5F, -20.5F, -9.2F);
		...
		bodyModel[181].setRotationPoint(-5F, -20.5F, 4.8F);
		...
		bodyModel[182].setRotationPoint(-5F, -17.5F, 4.8F);
		...
		bodyModel[183].setRotationPoint(-5F, -17.5F, 7.8F);
		...
		bodyModel[184].setRotationPoint(-5F, -20.5F, 7.8F);

		bodyModel[185].addBox(0F, 0F, 0F, 1, 4, 1, 0F); // Box 185
		bodyModel[185].setRotationPoint(-5F, -20.5F, 8.8F);

		bodyModel[186].addBox(0F, 0F, 0F, 2, 1, 1, 0F); // Box 94
		bodyModel[186].setRotationPoint(-52.5F, -10F, -0.5F);
		...
		bodyModel[187].setRotationPoint(-53.5F, -10F, -2.5F);
		...
		bodyModel[191].setRotationPoint(1F, -10.5F, -1.7F);
		...
		bodyModel[192].setRotationPoint(-58.9F, 2.5F, -1.1F);
		...
		bodyModel[193].setRotationPoint(-58.9F, 1.5F, -1.1F);
		...
		bodyModel[194].setRotationPoint(0.9F, 2.5F, -1.1F);
		...
		bodyModel[195].setRotationPoint(1.9F, 1.5F, -1.1F);
		...
		bodyModel[196].setRotationPoint(-48F, -4.5F, -11.21F);
		...
		bodyModel[197].setRotationPoint(-44.5F, -4.5F, -11.21F);
		...
		bodyModel[198].setRotationPoint(-47F, -2F, -11.22F);
		...
		bodyModel[199].setRotationPoint(-41F, -4.5F, -11.21F);
		...
		bodyModel[200].setRotationPoint(-48F, -4.5F, 10.81F);
		...
		bodyModel[201].setRotationPoint(-44.5F, -4.5F, 10.81F);
		...
		bodyModel[202].setRotationPoint(-47F, -2F, 10.82F);
		...
		bodyModel[203].setRotationPoint(-41F, -4.5F, 10.81F);
		...
		bodyModel[204].setRotationPoint(-6F, -8.6F, -11.24F);
		...
		bodyModel[205].setRotationPoint(-6F, -8.6F, 10.81F);

		bodyModel[206].addBox(0F, 0F, 0F, 4, 5, 1, 0F); // Box 100
		bodyModel[206].setRotationPoint(-11.5F, 0.5F, 9F);

		bodyModel[207].addBox(0F, 0F, 0F, 4, 1, 1, 0F); // Box 100
		bodyModel[207].setRotationPoint(-11.5F, 4.5F, 10F);

		bodyModel[208].addBox(0F, 0F, 0F, 4, 1, 1, 0F); // Box 100
		bodyModel[208].setRotationPoint(-11.5F, 1.5F, -11F);

		bodyModel[209].addBox(0F, 0F, 0F, 4, 5, 1, 0F); // Box 100
		bodyModel[209].setRotationPoint(-11.5F, 0.5F, -10F);

		bodyModel[210].addBox(0F, 0F, 0F, 4, 1, 1, 0F); // Box 100
		bodyModel[210].setRotationPoint(-11.5F, 4.5F, -11F);
		...
		bodyModel[211].setRotationPoint(-47F, -25F, -1.6F);
		...
		bodyModel[212].setRotationPoint(-48F, -24.5F, -2.6F);
		...
		bodyModel[213].setRotationPoint(-4F, -16.5F, -11.2F);
		...
		bodyModel[214].setRotationPoint(-4F, -14.5F, -11.2F);

		bodyModel[215].addBox(0F, 0F, 0F, 1, 6, 1, 0F); // Box 174
		bodyModel[215].setRotationPoint(0F, -18.5F, -11.2F);
		...
		bodyModel[216].setRotationPoint(-4F, -18.5F, 9.8F);
		...
		bodyModel[217].setRotationPoint(-4F, -16.5F, 9.8F);
		...
		bodyModel[218].setRotationPoint(-4F, -14.5F, 9.8F);
		...
		bodyModel[219].setRotationPoint(-7F, -13.5F, -11.2F);
		...
		bodyModel[220].setRotationPoint(-7F, -19.5F, -11.2F);
		...
		bodyModel[221].setRotationPoint(-11F, -19.5F, -11.2F);
		...
		bodyModel[222].setRotationPoint(-11F, -13.5F, -11.2F);
		...
		bodyModel[223].setRotationPoint(-7F, -13.5F, 9.8F);
		...
		bodyModel[224].setRotationPoint(-7F, -19.5F, 9.8F);
		...
		bodyModel[225].setRotationPoint(-11F, -19.5F, 9.8F);
		...
		bodyModel[226].setRotationPoint(-11F, -13.5F, 9.8F);
		...
		bodyModel[227].setRotationPoint(-47F, -25F, 0.2F);
		...
		bodyModel[228].setRotationPoint(-48F, -24.5F, 0.2F);
		...
		bodyModel[229].setRotationPoint(-45.5F, 3F, -7.2F);
		...
		bodyModel[230].setRotationPoint(-27.5F, 3F, -7.2F);
		...
		bodyModel[231].setRotationPoint(-43.5F, 6F, 6F);
		...
		bodyModel[232].setRotationPoint(-25.5F, 6F, 6F);
		...
		bodyModel[233].setRotationPoint(-15F, -12.5F, 9.8F);
		...
		bodyModel[234].setRotationPoint(-7F, -12.5F, 9.8F);

		bodyModel[235].addBox(0F, 0F, 0F, 7, 1, 4, 0F); // Box 32
		bodyModel[235].setRotationPoint(-40F, -4.5F, 5.8F);
		...
		bodyModel[236].setRotationPoint(-47F, -25F, -0.8F);
		...
		bodyModel[237].setRotationPoint(-48F, -24.5F, -0.8F);
		...
		bodyModel[238].setRotationPoint(-33F, -20.5F, -2.2F);
		...
		bodyModel[239].setRotationPoint(-33F, -20.5F, -0.2F);
		...
		bodyModel[240].setRotationPoint(-33F, -22.5F, -2.2F);
		...
		bodyModel[241].setRotationPoint(-40F, -12.5F, -9F);
		...
		bodyModel[242].setRotationPoint(-39F, -12.5F, -10F);
		...
		bodyModel[243].setRotationPoint(-40F, -12.5F, -10F);
		...
		bodyModel[244].setRotationPoint(-39.5F, -12.5F, -9.5F);
		...
		bodyModel[245].setRotationPoint(-40F, -12.5F, 7.5F);
		...
		bodyModel[246].setRotationPoint(-40F, -12.5F, 8.5F);
		...
		bodyModel[247].setRotationPoint(-39F, -12.5F, 7.5F);
		...
		bodyModel[249].setRotationPoint(-39.5F, -12.5F, 8F);
		...
		bodyModel[250].setRotationPoint(-33F, -22.5F, -0.2F);
		...
		bodyModel[251].setRotationPoint(-55.5F, -2F, 7.5F);
		...
		bodyModel[252].setRotationPoint(-55.5F, -2F, -9.5F);
		...
		bodyModel[253].setRotationPoint(-55.5F, -2F, -0.5F);

		bodyModel[254].addBox(0F, 0F, 0F, 10, 10, 0, 0F); // Box 5
		bodyModel[254].setRotationPoint(-14F, 0F, -6.3F);

		bodyModel[255].addBox(0F, 0F, 0F, 10, 10, 0, 0F); // Box 5
		bodyModel[255].setRotationPoint(-14F, 0F, 6F);

		bodyModel[256].addShapeBox(0F, 0F, 0F, 14, 1, 1, 0F,0F, 0F, -0.21F, 0F, 0F, -0.21F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -0.21F, 0F, 0F, -0.21F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 74
		bodyModel[256].setRotationPoint(-22.5F, 6F, 5.8F);

		bodyModel[257].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F,0.2F, 0.2F, 0F, 0.2F, 0.2F, 0F, 0.2F, 0.2F, 0F, 0.2F, 0.2F, 0F, 0.2F, 0.2F, 0F, 0.2F, 0.2F, 0F, 0.2F, 0.2F, 0F, 0.2F, 0.2F, 0F); // Box 75
		bodyModel[257].setRotationPoint(-8.5F, 6F, 6F);

		bodyModel[258].addBox(0F, 0F, 0F, 15, 1, 1, 0F); // Box 75
		bodyModel[258].setRotationPoint(-24.5F, 3F, -7F);

		bodyModel[259].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F,0.2F, 0.2F, 0F, 0.2F, 0.2F, 0F, 0.2F, 0.2F, 0F, 0.2F, 0.2F, 0F, 0.2F, 0.2F, 0F, 0.2F, 0.2F, 0F, 0.2F, 0.2F, 0F, 0.2F, 0.2F, 0F); // Box 75
		bodyModel[259].setRotationPoint(-10.5F, 3F, -7.2F);

		bodyModel[260].addShapeBox(0F, 0F, 0F, 68, 21, 1, 0F,0F, 0F, 0F, -50F, 0F, 0F, -50F, 0F, 0F, 0F, 0F, 0F, 0F, -14F, 0F, -50F, -14F, 0F, -50F, -14F, 0F, 0F, -14F, 0F); // Box 20
		bodyModel[260].setRotationPoint(-34F, -10.5F, 9.8F);

		bodyModel[261].addShapeBox(0F, 0F, 0F, 68, 21, 1, 0F,0F, 0F, 0F, -50F, 0F, 0F, -50F, 0F, 0F, 0F, 0F, 0F, 0F, -14F, 0F, -50F, -14F, 0F, -50F, -14F, 0F, 0F, -14F, 0F); // Box 23
		bodyModel[261].setRotationPoint(-34F, -10.5F, -11.2F);

		bodyModel[262].addShapeBox(0F, 0F, 0F, 68, 3, 4, 0F,0F, 0F, 0F, -50F, 0F, 0F, -50F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 0F, -50F, -2F, 0F, -50F, -2F, 0F, 0F, -2F, 0F); // Box 25
		bodyModel[262].setRotationPoint(-34F, -11.5F, -11.2F);

		bodyModel[263].addBox(0F, 0F, 0F, 1, 7, 4, 0F); // Box 26
		bodyModel[263].setRotationPoint(-34F, -10.5F, -10.2F);

		bodyModel[264].addBox(0F, 0F, 0F, 1, 7, 4, 0F); // Box 27
		bodyModel[264].setRotationPoint(-34F, -10.5F, 5.8F);

		bodyModel[265].addShapeBox(0F, 0F, 0F, 68, 3, 4, 0F,0F, 0F, 0F, -50F, 0F, 0F, -50F, 0F, 0F, 0F, 0F, 0F, 0F, -2F, 0F, -50F, -2F, 0F, -50F, -2F, 0F, 0F, -2F, 0F); // Box 28
		bodyModel[265].setRotationPoint(-34F, -11.5F, 6.8F);

		bodyModel[266].addShapeBox(0F, 0F, 0F, 2, 1, 1, 0F,0F, -0.6F, 0F, 0F, -0.6F, 0F, -0.7F, 0F, -0.3F, -0.7F, 0F, -0.3F, 0F, 0F, 0F, 0F, 0F, 0F, -0.6F, 0F, -0.3F, -0.6F, 0F, -0.3F); // Box 182
		bodyModel[266].setRotationPoint(-33F, -12.5F, -10F);

		bodyModel[267].addShapeBox(0F, 0F, 0F, 2, 1, 1, 0F,-0.7F, 0F, -0.3F, -0.7F, 0F, -0.3F, 0F, -0.6F, 0F, 0F, -0.6F, 0F, -0.6F, 0F, -0.3F, -0.6F, 0F, -0.3F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 182
		bodyModel[267].setRotationPoint(-33F, -12.5F, -9F);

		bodyModel[268].addShapeBox(0F, 0F, 0F, 1, 1, 2, 0F,-0.3F, 0F, -0.7F, 0F, -0.6F, 0F, 0F, -0.6F, 0F, -0.3F, 0F, -0.7F, -0.3F, 0F, -0.6F, 0F, 0F, 0F, 0F, 0F, 0F, -0.3F, 0F, -0.6F); // Box 182
		bodyModel[268].setRotationPoint(-32F, -12.5F, -10F);

		bodyModel[269].addShapeBox(0F, 0F, 0F, 1, 1, 2, 0F,0F, -0.6F, 0F, -0.3F, 0F, -0.7F, -0.3F, 0F, -0.7F, 0F, -0.6F, 0F, 0F, 0F, 0F, -0.3F, 0F, -0.6F, -0.3F, 0F, -0.6F, 0F, 0F, 0F); // Box 182
		bodyModel[269].setRotationPoint(-33F, -12.5F, -10F);

		bodyModel[270].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F,-0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F); // Box 182
		bodyModel[270].setRotationPoint(-32.5F, -12.5F, -9.5F);

		bodyModel[271].addShapeBox(0F, 0F, 0F, 2, 1, 1, 0F,0F, -0.6F, 0F, 0F, -0.6F, 0F, -0.7F, 0F, -0.3F, -0.7F, 0F, -0.3F, 0F, 0F, 0F, 0F, 0F, 0F, -0.6F, 0F, -0.3F, -0.6F, 0F, -0.3F); // Box 182
		bodyModel[271].setRotationPoint(-33F, -12.5F, 7.5F);

		bodyModel[272].addShapeBox(0F, 0F, 0F, 2, 1, 1, 0F,-0.7F, 0F, -0.3F, -0.7F, 0F, -0.3F, 0F, -0.6F, 0F, 0F, -0.6F, 0F, -0.6F, 0F, -0.3F, -0.6F, 0F, -0.3F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 182
		bodyModel[272].setRotationPoint(-33F, -12.5F, 8.5F);

		bodyModel[273].addShapeBox(0F, 0F, 0F, 1, 1, 2, 0F,-0.3F, 0F, -0.7F, 0F, -0.6F, 0F, 0F, -0.6F, 0F, -0.3F, 0F, -0.7F, -0.3F, 0F, -0.6F, 0F, 0F, 0F, 0F, 0F, 0F, -0.3F, 0F, -0.6F); // Box 182
		bodyModel[273].setRotationPoint(-32F, -12.5F, 7.5F);

		bodyModel[274].addShapeBox(0F, 0F, 0F, 1, 1, 2, 0F,0F, -0.6F, 0F, -0.3F, 0F, -0.7F, -0.3F, 0F, -0.7F, 0F, -0.6F, 0F, 0F, 0F, 0F, -0.3F, 0F, -0.6F, -0.3F, 0F, -0.6F, 0F, 0F, 0F); // Box 182
		bodyModel[274].setRotationPoint(-33F, -12.5F, 7.5F);

		bodyModel[275].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F,-0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F, -0.2F, 0F, -0.2F); // Box 182
		bodyModel[275].setRotationPoint(-32.5F, -12.5F, 8F);

		bodyModel[276].addShapeBox(0F, 0F, 0F, 2, 3, 1, 0F,-0.7F, 0.2F, 0F, -0.7F, 0.2F, 0F, 0F, 0.2F, 0F, 0F, 0.2F, 0F, -0.7F, 0F, 0F, -0.7F, 0F, 0F, -0.1F, 0F, 0F, 0F, 0F, 0F); // Box 109
		bodyModel[276].setRotationPoint(-36.3F, -5F, 7.5F);

		bodyModel[277].addShapeBox(0F, 0F, 0F, 2, 3, 1, 0F,0F, 0.2F, 0F, 0F, 0.2F, 0F, -0.7F, 0.2F, 0F, -0.7F, 0.2F, 0F, 0F, 0F, 0F, -0.1F, 0F, 0F, -0.7F, 0F, 0F, -0.7F, 0F, 0F); // Box 109
		bodyModel[277].setRotationPoint(-36.3F, -5F, 8.5F);

		bodyModel[278].addShapeBox(0F, 0F, 0F, 2, 10, 1, 0F,-0.9F, 0F, -0.6F, -0.9F, 0F, -0.6F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, -0.9F, 0F, -0.6F, -0.9F, 0F, -0.6F, -0.5F, 0F, 0F, -0.5F, 0F, 0F); // Box 109
		bodyModel[278].setRotationPoint(-36.3F, -10F, 7.5F);

		bodyModel[279].addShapeBox(0F, 0F, 0F, 2, 3, 1, 0F,-0.7F, -0.5F, 0F, -0.7F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, -0.7F, -0.5F, 0F, -0.7F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F); // Box 109
		bodyModel[279].setRotationPoint(-36.3F, -9F, 7.5F);

		bodyModel[280].addShapeBox(0F, 0F, 0F, 2, 3, 1, 0F,0F, -0.5F, 0F, 0F, -0.5F, 0F, -0.7F, -0.5F, 0F, -0.7F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, -0.7F, -0.5F, 0F, -0.7F, -0.5F, 0F); // Box 109
		bodyModel[280].setRotationPoint(-36.3F, -9F, 8.5F);

		bodyModel[281].addShapeBox(0F, 0F, 0F, 2, 10, 1, 0F,-0.5F, 0F, 0F, -0.5F, 0F, 0F, -0.9F, 0F, -0.6F, -0.9F, 0F, -0.6F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, -0.9F, 0F, -0.6F, -0.9F, 0F, -0.6F); // Box 109
		bodyModel[281].setRotationPoint(-36.3F, -10F, 8.5F);

		bodyModel[282].addShapeBox(0F, 0F, 0F, 1, 7, 1, 0F,-0.8F, -0.5F, -0.4F, 0F, -0.5F, -0.4F, 0F, -0.5F, -0.4F, -0.8F, -0.5F, -0.4F, -0.8F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, -0.8F, 0F, -0.4F); // Box 109
		bodyModel[282].setRotationPoint(-36.3F, -7F, 6.5F);

		bodyModel[283].addShapeBox(0F, 0F, 0F, 1, 1, 2, 0F,-0.8F, -0.5F, -0.6F, 0F, -0.5F, -0.6F, 0F, -0.5F, -0.4F, -0.8F, -0.5F, -0.4F, -0.8F, -0.3F, -0.6F, 0F, -0.3F, -0.6F, 0F, -0.3F, -0.4F, -0.8F, -0.3F, -0.4F); // Box 109
		bodyModel[283].setRotationPoint(-36.3F, -7F, 6.5F);

		bodyModel[284].addShapeBox(0F, 0F, 0F, 1, 6, 1, 0F,-0.8F, -0.5F, -0.4F, 0F, -0.5F, -0.4F, 0F, -0.5F, -0.4F, -0.8F, -0.5F, -0.4F, -0.8F, 0F, -0.4F, 0F, 0F, -0.4F, 0F, 0F, -0.4F, -0.8F, 0F, -0.4F); // Box 109
		bodyModel[284].setRotationPoint(-35.3F, -6F, 9.1F);

		bodyModel[285].addShapeBox(0F, 0F, 0F, 1, 1, 2, 0F,0F, -0.5F, -0.2F, -0.8F, -0.5F, -0.2F, 0F, -0.5F, -1F, -0.8F, -0.5F, -0.9F, 0F, -0.3F, -0.2F, -0.8F, -0.3F, -0.2F, 0F, -0.3F, -1F, -0.8F, -0.3F, -0.9F); // Box 109
		bodyModel[285].setRotationPoint(-35.3F, -6F, 8.5F);

		bodyModel[286].addBox(0F, 0F, 0F, 14, 4, 1, 0F); // Box 51
		bodyModel[286].setRotationPoint(-48F, -4.5F, -6.2F);

		bodyModel[287].addBox(0F, 0F, 0F, 14, 5, 1, 0F); // Box 52
		bodyModel[287].setRotationPoint(-48F, -4.5F, 4.8F);
	}
