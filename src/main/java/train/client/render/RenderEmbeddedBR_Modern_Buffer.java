...
import train.common.tile.TileEmbeddedBR_Modern_Buffer;

public class RenderEmbeddedBR_Modern_Buffer extends TileEntitySpecialRenderer {
    ...
    public RenderEmbeddedBR_Modern_Buffer() {
    }
    ...
    public void renderTileEntityAt(TileEntity var1, double var2, double var4, double var6, float var8) {
        ...
        if (((TileEmbeddedBR_Modern_Buffer) var1).getDiagonalfacing()== 1 ||((TileEmbeddedBR_Modern_Buffer) var1).getDiagonalfacing()== 3 ||((TileEmbeddedBR_Modern_Buffer) var1).getDiagonalfacing()== 5 ||((TileEmbeddedBR_Modern_Buffer) var1).getDiagonalfacing()== 7)
        ...
        switch (((TileEmbeddedBR_Modern_Buffer) var1).getDiagonalfacing()) {
            case 0: {
